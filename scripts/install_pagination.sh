...
docker-compose exec web git clone --branch feature/jdcat_202412 https://github.com/RCOSDP/invenio-search-js.git /home/invenio/.virtualenvs/invenio/var/instance/static/node_modules/invenio-search-js
