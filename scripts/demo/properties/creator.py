...
def add(post_data, key, **kwargs):
    ...
    if kwargs.pop('mapping', True):
        post_data['table_row_map']['mapping'][key] = {
            ...
            'oai_dc_mapping': {
                'creator': {
                    '@value': 'creatorNames.creatorName,nameIdentifiers.nameIdentifier'
                }
            },
            'spase_mapping': ''
        }
        ...
        _d = {
            'items': [
                ...
                },
                {
                    ...
                    'items': [
                        {
                            'key': '{}.creatorAlternatives[].creatorAlternative'.format(key),
                            'title': '別名',
                            'title_i18n': {
                                'en': 'Alternative Name',
                                'ja': '別名'
                        ...
                        {
                            'key': '{}.creatorAlternatives[].creatorAlternativeLang'.format(key),
                            'title': '言語',
                            'title_i18n': {
                                'en': 'Language',
                                'ja': '言語'
                    ...
                    'items': [
                        {
                            ...
                            'items': [
                                {
                                    'key': '{}.creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifier'.format(key),
                                    'title': '所属機関識別子',
                                    'title_i18n': {
                                ...
                                {
                                    'key': '{}.creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierScheme'.format(key),
                                    'title': '所属機関識別子Scheme',
                                    'title_i18n': {
                                ...
                                {
                                    'key': '{}.creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierURI'.format(key),
                                    'title': '所属機関識別子URI',
                                    'title_i18n': {
                            ...
                            'key': '{}.creatorAffiliations[].affiliationNameIdentifiers'.format(key),
                            'style': {
                                'add': 'btn-success'
                            },
                            'title': '所属機関識別子',
                        ...
                        },
                        {
                            ...
                            'items': [
                                {
                                    'key': '{}.creatorAffiliations[].affiliationNames[].affiliationName'.format(key),
                                    'title': '所属機関名',
                                    'title_i18n': {
                                        'en': 'Affiliation Name',
                                        'ja': '所属機関名'
                                ...
                                {
                                    'key': '{}.creatorAffiliations[].affiliationNames[].affiliationNameLang'.format(key),
                                    'title': '言語',
                                    'title_i18n': {
                                        'en': 'Language',
                                        'ja': '言語'
                            ...
                            'key': '{}.creatorAffiliations[].affiliationNames'.format(key),
                            'style': {
                                'add': 'btn-success'
                            },
                            'title': '所属機関名',
                ...
                },
                {
                    ...
                    'onClick': "searchAuthor('{}', true, form)".format(key.replace('[]', '')),
