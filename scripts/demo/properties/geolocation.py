            ...
            "items": [
                {
                    "items": [
                        {
                            "key": "{}.subitem_geolocation_point.subitem_point_longitude".format(
                                key
                            ),
                            "title": "経度",
                        ...
                        {
                            "key": "{}.subitem_geolocation_point.subitem_point_latitude".format(
                                key
                            ),
                            "title": "緯度",
                    ...
                    "type": "fieldset",
                    "title": "位置情報（点）",
                    "title_i18n": {"en": "Geo Location Point", "ja": "位置情報（点）"},
                },
                {
                    "items": [
                        {
                            "key": "{}.subitem_geolocation_box.subitem_west_longitude".format(
                                key
                            ),
                            "title": "西部経度",
                            "title_i18n": {"en": "West Bound Longitude", "ja": "西部経度"},
                            "type": "text",
                        },
                        {
                            "key": "{}.subitem_geolocation_box.subitem_east_longitude".format(
                                key
                            ),
                            "title": "東部経度",
                            "title_i18n": {"en": "East Bound Longitude", "ja": "東部経度"},
                            "type": "text",
                        },
                        {
                            "key": "{}.subitem_geolocation_box.subitem_south_latitude".format(
                                key
                            ),
                            "title": "南部緯度",
                            "title_i18n": {"en": "South Bound Latitude", "ja": "南部緯度"},
                            "type": "text",
                        },
                        {
                            "key": "{}.subitem_geolocation_box.subitem_north_latitude".format(
                                key
                            ),
                            "title": "北部緯度",
                            "title_i18n": {"en": "North Bound Latitude", "ja": "北部緯度"},
                            "type": "text",
                        },
                    ],
                    ...
                    "type": "fieldset",
                    "title": "位置情報（空間）",
                    "title_i18n": {"en": "Geo Location Box", "ja": "位置情報（空間）"},
                },
                {
                    "add": "New",
                    "items": [
                        {
                            "key": "{}.subitem_geolocation_place[].subitem_geolocation_place_text".format(
                                key
                            ),
                            "title": "位置情報（自由記述）",
                            "title_i18n": {
                    ...
                    "title": "位置情報（自由記述）",
                    "title_i18n": {"en": "Geo Location Place", "ja": "位置情報（自由記述）"},
                },
            ],
            "key": key.replace("[]", ""),
        }
