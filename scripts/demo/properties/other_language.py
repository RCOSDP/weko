...
mapping = {
    ...
    "jpcoar_mapping": {"language": {"@value": "subitem_language"}},
    "junii2_mapping": "",
    "lido_mapping": "",
    "lom_mapping": "",
    "oai_dc_mapping": {"language": {"@value": "subitem_language"}},
    "spase_mapping": "",
}
...
def schema(title="", multi_flag=multiple_flag):
    ...
    def _schema():
        ...
        _d = {
            "type": "object",
            "properties": {
                "subitem_language": {"type": "string", "format": "text", "title": "言語"}
            },
        }
        return _d
