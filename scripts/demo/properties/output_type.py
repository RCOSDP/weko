...
output_type = {
    ...
    "Conference report (international conference or abroad conference)": "学会報告（国際学会または国外学会）",
    "Conference report (domestic conference)": "学会報告（国内学会）",
    "Others": "その他",
}
            ...
            "items": [
                {
                    ...
                    "title": "成果物のタイプ",
                    "title_i18n": {"en": "Output Type", "ja": "成果物のタイプ"},
