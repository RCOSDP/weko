...
def add(post_data, key, **kwargs):
    """Add contributor to a item type."""
        ...
        _d = {
            'items': [
                ...
                },
                {
                    ...
                    'items': [
                        {
                            'key': '{}.nameIdentifiers[].nameIdentifierScheme'.format(key),
                            'title': '寄与者識別子Scheme',
                            'title_i18n': {
                ...
                },
                {
                    ...
                    'items': [
                        {
                            'key': '{}.contributorAlternatives[].contributorAlternativeLang'.format(key),
                            'title': '言語',
                            'title_i18n': {
                                'en': 'Language',
                                'ja': '言語'
                        ...
                        {
                            'key': '{}.contributorAlternatives[].contributorAlternative'.format(key),
                            'title': '別名',
                            'title_i18n': {
                                'en': 'Alternative Name',
                                'ja': '別名'
                    ...
                    'items': [
                        {
                            ...
                            'items': [
                                {
                                    'key': '{}.contributorAffiliations[].contributorAffiliationNameIdentifiers[].contributorAffiliationNameIdentifier'.format(key),
                                    'title': '所属機関識別子',
                                    'title_i18n': {
                                ...
                                {
                                    'key': '{}.contributorAffiliations[].contributorAffiliationNameIdentifiers[].contributorAffiliationScheme'.format(key),
                                    'title': '所属機関識別子Scheme',
                                    'title_i18n': {
                                        'en': 'Affiliation Name Identifier Scheme',
                                        'ja': '所属機関識別子Scheme'
                                    },
                                    'titleMap': get_select_value(config.AFFILIATION_SCHEME_VAL),
                                    'type': 'select'
                                },
                                {
                                    'key': '{}.contributorAffiliations[].contributorAffiliationNameIdentifiers[].contributorAffiliationURI'.format(key),
                                    'title': '所属機関識別子URI',
                                    'title_i18n': {
                            ...
                            'key': '{}.contributorAffiliations[].contributorAffiliationNameIdentifiers'.format(key),
                            'style': {
                                'add': 'btn-success'
                            },
                            'title': '所属機関識別子',
                        ...
                        },
                        {
                            ...
                            'items': [
                                {
                                    'key': '{}.contributorAffiliations[].contributorAffiliationNames[].contributorAffiliationName'.format(key),
                                    'title': '所属機関名',
                                    'title_i18n': {
                                        'en': 'Affiliation Name',
                                        'ja': '所属機関名'
                                ...
                                {
                                    'key': '{}.contributorAffiliations[].contributorAffiliationNames[].contributorAffiliationNameLang'.format(key),
                                    'title': '言語',
                                    'title_i18n': {
                                        'en': 'Language',
                                        'ja': '言語'
                            ...
                            'key': '{}.contributorAffiliations[].contributorAffiliationNames'.format(key),
                            'style': {
                                'add': 'btn-success'
                            },
                            'title': '所属機関名',
