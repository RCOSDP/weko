...
relation_type = [None, "isReferencedBy"]
            ...
            "items": [
                {
                    ...
                    "items": [
                        {
                            "key": "{}.subitem_related_publication_titles[].subitem_related_publication_title".format(
                                key
                            ),
                            "title": "関連文献タイトル",
                            "title_i18n": {
                        ...
                        {
                            "key": "{}.subitem_related_publication_titles[].subitem_related_publication_title_language".format(
                                key
                            ),
                            "title": "言語",
                            "title_i18n": {"en": "Language", "ja": "言語"},
                ...
                },
                {
                    "items": [
                        {
                            "key": "{}.subitem_related_publication_identifiers.subitem_related_publication_identifier".format(
                                key
                            ),
                            "title": "関連文献識別子",
                            "title_i18n": {
                        ...
                        {
                            "key": "{}.subitem_related_publication_identifiers.subitem_related_publication_identifier_type".format(
                                key
                            ),
                            "title": "関連文献識別子タイプ",
                            "title_i18n": {
