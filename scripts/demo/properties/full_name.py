                    ...
                    'items': [
                        {
                            ...
                            'items': [
                                {
                                    'key': '{}.affiliations[].affiliationNameIdentifiers[].affiliationNameIdentifier'.format(key),
                                    'title': '所属機関識別子',
                                    'title_i18n': {
                                ...
                                {
                                    'key': '{}.affiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierScheme'.format(key),
                                    'title': '所属機関識別子Scheme',
                                    'title_i18n': {
                                ...
                                {
                                    'key': '{}.affiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierURI'.format(key),
                                    'title': '所属機関識別子URI',
                                    'title_i18n': {
                            ...
                            'key': '{}.affiliations[].affiliationNameIdentifiers'.format(key),
                            'style': {
                                'add': 'btn-success'
                            },
                            'title': '所属機関識別子',
                        ...
                        },
                        {
                            ...
                            'items': [
                                {
                                    'key': '{}.affiliations[].affiliationNames[].affiliationName'.format(key),
                                    'title': '所属機関名',
                                    'title_i18n': {
                                        'en': 'Affiliation Name',
                                        'ja': '所属機関名'
                                ...
                                {
                                    'key': '{}.affiliations[].affiliationNames[].affiliationNameLang'.format(key),
                                    'title': '言語',
                                    'title_i18n': {
                                        'en': 'Language',
                                        'ja': '言語'
