...
mapping = {
    ...
    "jpcoar_v1_mapping": {
        "conference": {
            ...
            "conferenceSequence": {"@value": "subitem_conference_sequence"},
            "conferenceSponsor": {
                "@attributes": {
            ...
            "conferenceCountry": {"@value": "subitem_conference_country"},
        }
    },
    "jpcoar_mapping": {
        "conference": {
            ...
            "items": [
                {
                    ...
                    "items": [
                        {
                            "key": "{}.subitem_conference_names[].subitem_conference_name".format(
                                key
                            ),
                            "title": "会議名",
                            "title_i18n": {"en": "Conference Name", "ja": "会議名"},
                            "type": "text",
                        },
                        {
                            "key": "{}.subitem_conference_names[].subitem_conference_name_language".format(
                                key
                            ),
                            "title": "言語",
                ...
                },
                {
                    ...
                    "items": [
                        {
                            "key": "{}.subitem_conference_sponsors[].subitem_conference_sponsor".format(
                                key
                            ),
                            "title": "主催機関",
                            "title_i18n": {"en": "Conference Sponsor", "ja": "主催機関"},
                            "type": "text",
                        },
                        {
                            "key": "{}.subitem_conference_sponsors[].subitem_conference_sponsor_language".format(
                                key
                            ),
                            "title": "言語",
                            "title_i18n": {"en": "Language", "ja": "言語"},
                ...
                },
                {
                    "items": [
                        {
                            "key": "{}.subitem_conference_date.subitem_conference_start_year".format(
                                key
                            ),
                            "title": "開始年",
                        ...
                        {
                            "key": "{}.subitem_conference_date.subitem_conference_start_month".format(
                                key
                            ),
                            "title": "開始月",
                        ...
                        {
                            "key": "{}.subitem_conference_date.subitem_conference_start_day".format(
                                key
                            ),
                            "title": "開始日",
                        ...
                        {
                            "key": "{}.subitem_conference_date.subitem_conference_end_year".format(
                                key
                            ),
                            "title": "終了年",
                        ...
                        {
                            "key": "{}.subitem_conference_date.subitem_conference_end_month".format(
                                key
                            ),
                            "title": "終了月",
                        ...
                        {
                            "key": "{}.subitem_conference_date.subitem_conference_end_day".format(
                                key
                            ),
                            "title": "終了日",
                        ...
                        {
                            "key": "{}.subitem_conference_date.subitem_conference_period".format(
                                key
                            ),
                            "title": "開催期間",
                            "title_i18n": {"en": "Conference Date", "ja": "開催期間"},
                            "type": "text",
                        },
                        {
                            "key": "{}.subitem_conference_date.subitem_conference_date_language".format(
                                key
                            ),
                            "title": "言語",
                            "title_i18n": {"en": "Language", "ja": "言語"},
                ...
                },
                {
                    ...
                    "items": [
                        {
                            "key": "{}.subitem_conference_venues[].subitem_conference_venue".format(
                                key
                            ),
                            "title": "開催会場",
                            "title_i18n": {"en": "Conference Venue", "ja": "開催会場"},
                            "type": "text",
                        },
                        {
                            "key": "{}.subitem_conference_venues[].subitem_conference_venue_language".format(
                                key
                            ),
                            "title": "言語",
                            "title_i18n": {"en": "Language", "ja": "言語"},
                ...
                },
                {
                    ...
                    "items": [
                        {
                            "key": "{}.subitem_conference_places[].subitem_conference_place".format(
                                key
                            ),
                            "title": "開催地",
                            "title_i18n": {"en": "Conference Place", "ja": "開催地"},
                            "type": "text",
                        },
                        {
                            "key": "{}.subitem_conference_places[].subitem_conference_place_language".format(
                                key
                            ),
                            "title": "言語",
                            "title_i18n": {"en": "Language", "ja": "言語"},
                ...
                },
                {
                    ...
                    "title": "開催国",
                    "title_i18n": {"en": "Conference Country", "ja": "開催国"},
