        ...
        _d = {
            'items': [
                ...
                },
                {
                    'items': [
                        {
                            'key': '{}.subitem_relation_type_id.subitem_relation_type_select'.format(key),
                            'title': '識別子タイプ',
                            'title_i18n': {
                                'en': 'Identifier Type',
                                'ja': '識別子タイプ'
                        ...
                        {
                            'key': '{}.subitem_relation_type_id.subitem_relation_type_id_text'.format(key),
                            'title': '関連識別子',
                            'title_i18n': {
                ...
                },
                {
                    ...
                    'items': [
                        {
                            'key': '{}.subitem_relation_name[].subitem_relation_name_language'.format(key),
                            'title': '言語',
                            'title_i18n': {
                                'en': 'Language',
                                'ja': '言語'
                        ...
                        {
                            'key': '{}.subitem_relation_name[].subitem_relation_name_text'.format(key),
                            'title': '関連名称',
                            'title_i18n': {
                                'en': 'Related Title',
                                'ja': '関連名称'
