...
def add(post_data, key, **kwargs):
    """Add degree grantor to a item type."""
            ...
            'items': [
                {
                    ...
                    'items': [
                        {
                            'key': '{}.subitem_degreegrantor_identifier[].subitem_degreegrantor_identifier_scheme'.format(key),
                            'title': '学位授与機関識別子Scheme',
                            'title_i18n': {
                        ...
                        {
                            'key': '{}.subitem_degreegrantor_identifier[].subitem_degreegrantor_identifier_name'.format(key),
                            'title': '学位授与機関識別子',
                            'title_i18n': {
                ...
                },
                {
                    ...
                    'items': [
                        {
                            'key': '{}.subitem_degreegrantor[].subitem_degreegrantor_language'.format(key),
                            'title': '言語',
                            'title_i18n': {
                                'en': 'Language',
                                'ja': '言語'
                        ...
                        {
                            'key': '{}.subitem_degreegrantor[].subitem_degreegrantor_name'.format(key),
                            'title': '学位授与機関名',
                            'title_i18n': {
