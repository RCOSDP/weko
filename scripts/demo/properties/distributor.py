            ...
            "items": [
                {
                    ...
                    "title": "配布者、配布機関名",
                    "title_i18n": {"en": "Distributor Name", "ja": "配布者、配布機関名"},
                    "type": "text",
                },
                {
                ...
                },
                {
                    ...
                    "title": "配布機関略称",
                    "title_i18n": {"en": "Distributor Abbreviation", "ja": "配布機関略称"},
                    "type": "text",
                },
                {
                    "key": "{}.subitem_distributor_affiliation".format(key),
                    "title": "配布者の所属",
                    "title_i18n": {"en": "Distributor Affiliation", "ja": "配布者の所属"},
                    "type": "text",
                },
                {
                    "key": "{}.subitem_distributor_uri".format(key),
                    "title": "配布機関URI",
                    "title_i18n": {"en": "Distributor URI", "ja": "配布機関URI"},
                    "type": "text",
                },
                {
