...
def add(post_data, key, **kwargs):
    """Add bibliographic info to a item type."""
            ...
            'items': [
                {
                    ...
                    'items': [
                        {
                            'key': '{}.bibliographic_titles[].bibliographic_title'.format(key),
                            'title': 'タイトル',
                            'title_i18n': {
                                'en': 'Title',
                                'ja': 'タイトル'
                        ...
                        {
                            'key': '{}.bibliographic_titles[].bibliographic_titleLang'.format(key),
                            'title': '言語',
                            'title_i18n': {
                                'en': 'Language',
                                'ja': '言語'
                ...
                },
                {
                    'items': [
                        {
                            'key': '{}.bibliographicIssueDates.bibliographicIssueDate'.format(key),
                            'title': '日付',
                            'title_i18n': {
                                'en': 'Date',
                                'ja': '日付'
                        ...
                        {
                            'key': '{}.bibliographicIssueDates.bibliographicIssueDateType'.format(key),
                            'title': '日付タイプ',
                            'title_i18n': {
                                'en': 'Date Type',
                                'ja': '日付タイプ'
