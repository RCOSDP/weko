...
mapping = {
    ...
    "jpcoar_v1_mapping": {
        "date": {
            "@attributes": {"dateType": "subitem_restricted_access_approval_date_type"},
            ...
            "items": [
                {
                    ...
                    "title": "承認日",
                    "title_i18n": {"ja": "承認日", "en": "Approval Date"},
                    "type": "template",
                },
                {
                    "key": "{}.subitem_restricted_access_approval_date_type".format(
                        key
                    ),
                    "title": "承認日タイプ ",
                    "title_i18n": {"ja": "承認日タイプ ", "en": "Approval Date Type"},
