        ...
        _d = {
            'items': [
                ...
                },
                {
                    ...
                    'items': [
                        {
                            'key': '{}.subitem_affiliated_institution[].subitem_affiliated_institution_name'.format(key),
                            'title': '学会名',
                            'title_i18n': {
                        ...
                        {
                            'key': '{}.subitem_affiliated_institution[].subitem_affiliated_institution_position'.format(key),
                            'title': '学会役職',
                            'title_i18n': {
                                'en': 'Institution Position',
                                'ja': '学会役職'
                            },
                            'type': 'text'
                        }
