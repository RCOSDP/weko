...
SPECIFIED_LIST = [1001,1002,1005,1006,1009,1011,1012,1014,1015,1016,1018,1019,1022,1025,1026,1027,1028,1029,1030,1032,1038,1039,1048,1049,1050,1051,1052,1053,1054,1055,1056,1057]
...
DATE_TYPE_Label = [None,'Accepted', 'Available', 'Collected', 'Copyrighted', 'Created', 'Issued', 'Submitted', 'Updated', 'Valid']
