...
def reindex_and_add_items():
    ...
    try:
        ...
        #reindex_target_list = [stats_record_view_indices,stats_file_download_indices,events_stats_file_download_indices,stats_file_preview_indices,events_stats_file_preview_indices]
        reindex_target_dict['stats-record-view'] = stats_record_view_indices
        reindex_target_dict['stats-file-download'] = stats_file_download_indices
        reindex_target_dict['events-stats-file-download'] = events_stats_file_download_indices
        reindex_target_dict['stats-file-preview'] = stats_file_preview_indices
        reindex_target_dict['events-stats-file-preview'] = events_stats_file_preview_indices

        # インデックスの表示
        current_app.logger.info('record_view_indices:', record_view_indices)
        current_app.logger.info('file_download_indices:', file_download_indices)
        current_app.logger.info('file_preview_indices:', file_preview_indices)
        ...
        for index_list in [events_stats_file_download_indices, events_stats_file_preview_indices]:
            current_app.logger.info('call index_list',index_list)
