...
# data-backup-begin
docker cp $(docker-compose ps -q web):/home/invenio/.virtualenvs/invenio/var/instance/data ${BACKUPDIR}/
chown -R 1000:1000 ${BACKUPDIR}/data
# data-backup-end

# conf-backup-begin
docker cp $(docker-compose ps -q web):/home/invenio/.virtualenvs/invenio/var/instance/conf ${BACKUPDIR}/
