...
$config = array(
    ...
    'default-sp' => array(
        ...
        'entityID' => 'http://weko3.example.org/sp/simplesamlphp',
    ...
    */
    ...
    'example-userpass' => array(
        ...
        'student:studentpass' => array(
            ...
            'displayName'=>array('Taro Joho'),
            'sn'=>array('Joho, Taro'),
            'o'=>array('Abcdef University'),
            'ou'=>array('Open Science Center'),
            'givenName'=>array('Taro'),
            'eduPersonScopedAffiliation'=> array('member@example.org', 'student@example.org'),
            'eduPersonAssurance'=>array('http://idm.example.ac.jp/LOA#sample'),
            'eduPersonUniqueId'=>array('8827bc20c501a8b240a93ddd7d227b55c46cf3e225a7a0bf3d5f2c8567630df3@example.org'),
            'eduPersonOrcid'=>array('http://orcid.org/0000-0000-0000-0000'),
            'isMemberOf'=>array('https://voplatform.example.ac.jp/gr/FooGroup'),
            'jasn'=>array('太郎, 情報'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.1'=>array('太郎, 情報'),
            'jaGivenName'=>array('太郎'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.2'=>array('太郎'),
            'jaDisplayName'=>array('情報　太郎'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.3'=>array('情報　太郎'),
            'jao'=>array('あいうえお大学'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.4'=>array('あいうえお大学'),
            'jaou'=>array('オープンサイエンスセンター'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.5'=>array('オープンサイエンスセンター'),

        ),
        'info@inveniosoftware.org:uspass123' => array(
            'uid' => array('info@inveniosoftware.org'),
            'eduPersonAffiliation' => array('member', 'student'),
            'mail' => array('info@inveniosoftware.org'),
            'eduPersonPrincipalName' => array('info@inveniosoftware.org'),
            'displayName'=>array('Taro Joho'),
            'sn'=>array('Joho, Taro'),
            'o'=>array('Abcdef University'),
            'ou'=>array('Open Science Center'),
        ...
        'employee:employeepass' => array(
            'uid' => array('employee'),
            'eduPersonAffiliation' => array('member', 'employee'),
            'mail' => array('employee@example.org'),
            'eduPersonPrincipalName' => array('employee@example.org'),
            'displayName'=>array('Taro Joho'),
            'sn'=>array('Jiro, Taro'),
            'o'=>array('Abcdef University'),
            'ou'=>array('Open Science Center'),
            'givenName'=>array('Jiro'),
            'eduPersonScopedAffiliation'=> array('member@example.org', 'employee@example.org'),
            'eduPersonAssurance'=>array('http://idm.example.ac.jp/LOA#sample'),
            'eduPersonUniqueId'=>array('d4731661a8d075b6c7664e3bc0205788ff12b3f3844a8bae317e110887d95aca@example.org'),
            'eduPersonOrcid'=>array('http://orcid.org/0000-0000-0000-0000'),
            'isMemberOf'=>array('https://voplatform.example.ac.jp/gr/FooGroup'),
            'jasn'=>array('次郎, 情報'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.1'=>array('次郎, 情報'),
            'jaGivenName'=>array('次郎'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.2'=>array('次郎'),
            'jaDisplayName'=>array('情報　次郎'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.3'=>array('情報　次郎'),
            'jao'=>array('あいうえお大学'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.4'=>array('あいうえお大学'),
            'jaou'=>array('オープンサイエンスセンター'),
            'urn:oid:1.3.6.1.4.1.32264.1.1.5'=>array('オープンサイエンスセンター'),
