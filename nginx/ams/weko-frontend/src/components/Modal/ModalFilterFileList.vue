...
<template>
  <dialog id="modalFilterFileList" class="w-11/12 md:w-full max-w-[728px] mx-auto z-10">
        ...
        <div class="max-w-full mx-auto p-5">
          ...
          <div class="my-[15px] flex flex-wrap items-center gap-1">
            ...
            <div class="flex flex-wrap ml-2.5 w-full">
              <div class="checkbox">
                ...
                <label class="text-sm checkbox-label miby-dark-gray" for="type-group">csv</label>
              </div>
              <div class="checkbox">
                <input class="absolute" type="checkbox" name="publish-type" id="type-publish" />
                <label class="text-sm checkbox-label miby-dark-gray" for="type-publish">xlsx</label>
              </div>
              <div class="checkbox">
                <input class="absolute" type="checkbox" name="publish-type" id="type-private" />
                <label class="text-sm checkbox-label miby-dark-gray" for="type-private">png</label>
              </div>
              <div class="checkbox">
                <input class="absolute" type="checkbox" name="publish-type" id="type-limited" />
                <label class="text-sm checkbox-label miby-dark-gray" for="type-limited"
                  >mpeg4</label
                >
              </div>
            </div>
          ...
          <div class="my-[15px] flex flex-wrap items-center gap-1">
            ...
            <div class="flex flex-wrap ml-2.5 w-full">
              <div class="checkbox">
                <input class="absolute" type="checkbox" name="publish-type" id="type-group" />
                <label class="text-sm checkbox-label miby-dark-gray" for="type-group">無制限</label>
              </div>
              <div class="checkbox">
                <input class="absolute" type="checkbox" name="publish-type" id="type-publish" checked />
                <label class="text-sm checkbox-label miby-black" for="type-publish">利用許可申請必要</label>
              </div>
              <div class="checkbox">
                <input class="absolute" type="checkbox" name="publish-type" id="type-private" />
                <label class="text-sm checkbox-label miby-dark-gray" for="type-private">守秘義務契約必要</label>
              </div>
            </div>
          </div>
          <div class="my-[15px] flex flex-wrap items-center gap-1">
            ...
            <div class="flex flex-wrap ml-2.5 w-full">
              <div class="checkbox">
                <input class="absolute" type="checkbox" name="publish-type" id="type-group" />
                <label class="text-sm checkbox-label miby-dark-gray" for="type-group">あり</label>
              </div>
              <div class="checkbox">
                <input class="absolute" type="checkbox" name="publish-type" id="type-private" />
                <label class="text-sm checkbox-label miby-dark-gray" for="type-private">なし</label>
              </div>
            </div>
          </div>
          <div class="my-[15px] flex flex-wrap items-center gap-1">
