...
const $$Table = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result2, "SearchResultPage", null, { "client:only": "vue", "page": "table", "client:component-hydration": "only", "client:component-path": "C:/11_Weko/code/IVIS/weko-front/src/components/SearchResult/SearchResultPage.vue", "client:component-export": "default" })}
` }));
}, "C:/11_Weko/code/IVIS/weko-front/src/pages/search/table.astro");

const $$file = "C:/11_Weko/code/IVIS/weko-front/src/pages/search/table.astro";
const $$url = "/search/table";

export { $$Table as default, $$file as file, $$url as url };
