...
if(!$_SERVER['HTTP_WEKOSOCIETYAFFILIATION'] && $_SERVER['NO_CHECK_WEKOSOCIETYAFFILIATION'] != "TRUE"){
  ...
  $post_args["SHIB_ATTR_ACTIVE_FLAG"]=$_SERVER['HTTP_WEKOACTIVEUSER'];
  $post_args["SHIB_ATTR_SITE_USER_WITHIN_IP_RANGE_FLAG"]=$_SERVER['HTTP_WEKOSITEUSERWITHINIPRANGE'];
  $post_args["SHIB_ATTR_ORGANIZATION"] = $_SERVER['HTTP_UIDPDOMAINNAME'];
  $post_args["SHIB_ATTR_HANDLE"] = $_SERVER['HTTP_DISPLAYNAME'];
