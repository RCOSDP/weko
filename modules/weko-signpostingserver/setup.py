...
g = {}
with open(os.path.join('weko_signpostingserver', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
    version = g['__version__']

setup(
    name='weko-signpostingserver',
    version=version,
    description=__doc__,
    ...
    url='https://github.com/RCOSDP/weko-signpostingserver',
    packages=packages,
    zip_safe=False,
    ...
    entry_points={
        ...
        'invenio_base.blueprints': [
            ...
            'weko_signpostingserver.views:blueprint',
        ],
