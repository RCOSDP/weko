...
from weko_signpostingserver.api import requested_signposting, outside_url


@patch('weko_signpostingserver.api.outside_url',
       side_effect=['https://test.com/', 'https://test.com/records/1']
       )
@patch('weko_signpostingserver.api.get_record_permalink',
