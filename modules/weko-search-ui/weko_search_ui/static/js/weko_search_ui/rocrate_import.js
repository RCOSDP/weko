...
const urlCheck = window.location.origin + '/admin/items/rocrate_import/check'
const urlGetChangeIdentifierMode = window.location.origin + '/admin/items/rocrate_import/get_disclaimer_text'
const urlCheckStatus = window.location.origin + '/admin/items/rocrate_import/check_status'
const urlDownloadCheck = window.location.origin + '/admin/items/rocrate_import/download_check'
...
class MainLayout extends React.Component {
  ...
  handleCheck(formData) {
    ...
    $.ajax({
      ...
      success: function (response) {
        that.getCheckStatus(response.check_rocrate_import_task_id);
      },
  ...
  getCheckStatus(taskId) {
    ...
    $.ajax({
      url: window.location.origin + '/admin/items/rocrate_import/get_check_status',
      method: 'POST',
...
class RocrateImportComponent extends React.Component {
  ...
  getListMapping() {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        that.setState({ mappings: data });
      },
      error: function (error) {
        console.log(error);
        alert(error_get_lstMapping);
      }
    });
  }
