        ...
        try:
            for num, data_row in enumerate(csv_reader, start=1):
                if num == 1:
                    ...
                    current_app.logger.debug("duplication_item_ids: {}".format(duplication_item_ids))
                    # []
                    ...
                    if check_item_type:
                        ...
                        not_consistent_list = \
                            handle_check_consistence_with_mapping(
                                mapping_ids,
                                item_path)
                        current_app.logger.debug("not_consistent_list: {}".format(not_consistent_list))
                        # []
                        ...
                        current_app.logger.debug("item_path_not_existed: {}".format(item_path_not_existed))
                        # []
