...
def process_bulk_queue(version_type=None, search_bulk_kwargs=None, indexer_name=None,with_deleted=False):
    ...
    indexer.process_bulk_queue(search_bulk_kwargs=search_bulk_kwargs,with_deleted=with_deleted)
