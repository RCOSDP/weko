...
def test_authors_affiliation_settings_create(app, db):
    """
...
def test_authors_affiliation_settings_update(app, db):
    """
...
def test_authors_affiliation_settings_delete(app, db):
    """
