...
WEKO_AUTHORS_MESSAGE = {
    ...
    'WEKO_AUTHORS_REGIST_NEW_CREATOR': {
        ...
        'msgstr': "Register new creator in import file:{authorid} ",
        'msglvl': 'INFO',
    },
    'WEKO_AUTHORS_UPDATE_CREATOR': {
        'msgid': 'WEKO_AUTHORS_I_0010',
        'msgstr': "Update creator in import file: {authorid}",
        'msglvl': 'INFO',
    },
    'WEKO_AUTHORS_DELETE_CREATOR': {
        'msgid': 'WEKO_AUTHORS_I_0011',
        'msgstr': "Delete creator in import file: {authorid}",
        'msglvl': 'INFO',
    },
    ...
    'WEKO_AUTHORS_FAILED_UPDATE_CREATOR': {
        ...
        'msgstr': "FAILED to update creator in import file: {authorid}",
        'msglvl': 'ERROR',
    },
    'WEKO_AUTHORS_FAILED_DELETE_CREATOR': {
        'msgid': 'WEKO_AUTHORS_E_0010',
        'msgstr': "FAILED to delete creator in import file: {authorid}",
        'msglvl': 'ERROR',
    },
