...
WEKO_ACCOUNTS_MESSAGE = {
    ...
    'WEKO_INDEX_TREE_JOURNAL_FAILED_DISPLAY_SETTINGS_JOURNAL_INFO': {
        'msgid': 'WEKO_INDEX_TREE_JOURNAL_ERROR_0801',
