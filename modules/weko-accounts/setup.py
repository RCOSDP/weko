...
setup(
    ...
    entry_points={
        ...
        'invenio_assets.bundles': [
            'weko_accounts_embedded_ds_P1_js = weko_accounts.bundles:embedded_ds_P1_js',
            'weko_accounts_embedded_ds_P2_js = weko_accounts.bundles:embedded_ds_P1_js',
            'weko_accounts_embedded_ds_multi_lang_js = weko_accounts.bundles:embedded_ds_multi_language_js',
