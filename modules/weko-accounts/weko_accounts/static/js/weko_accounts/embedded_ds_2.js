...
// Kyushu - 九州
// Others - その他
var inc_type_list_checked = [];
var inc_categories_label = 'カテゴリ:';
var inc_categories_list = ['', 'University', 'College', 'Institute of Technology', 'Research Institute', 'Others'];
var inc_categories_list_label = ['全て', '大学', '短大', '高専', '研究所', 'その他'];
// Category - カテゴリ
// All - 全て
// University - 大学
// College - 短大
// Institute of Technology - 高専
...
function reset() {
  inc_search_list = inc_search_list_clone;
}
...
(function () {
  ...
  writeHTML('<div id="wayf_div_intro">');
  ...
  if (
    ...
    writeHTML('<script type="text/javascript" src="/static/js/weko_accounts/suggest.js"></script>');
    ...
    writeHTML('<div id="clear_a" class="default" title="A search key is emptied and it is the list display of all the IdP(s)." tabindex=11 onclick="reset();">Reset</div>');
    writeHTML('</td>');
    writeHTML('</tr>');
    writeHTML('</table>');
