...
WEKO_DEPOSIT_SYS_CREATOR_KEY = {
    'type': ['creatorType', 'contributorType'], #? ADDED 20231017 CREATOR TYPE BUG FIX
    'names': ['creatorNames', 'contributorNames', 'names'],
    'name': ['creatorName', 'contributorName', 'name'],
    'lang': ['creatorNameLang', 'lang', 'nameLang'],
    ...
    'alternative_names': ['creatorAlternatives', 'contributorAlternatives', 'alternatives'],
    'alternative_name': ['creatorAlternative', 'contributorAlternative', 'alternative'],
    'alternative_lang': ['creatorAlternativeLang', 'contributorAlternativeLang', 'alternativeLang'],
    'identifiers': ['nameIdentifiers'],
    'mails': ['creatorMails', 'contributorMails', 'mails'],
    'affiliation_name_identifier_scheme': ['affiliationNameIdentifierScheme', 'contributorAffiliationScheme'],
    'affiliation_names': ['affiliationNames', 'contributorAffiliationNames'], 
    'affiliation_name': ['affiliationName', 'contributorAffiliationName'],
    'affiliation_lang': ['affiliationNameLang', 'contributorAffiliationNameLang'],
    'affiliationNameIdentifiers': ['affiliationNameIdentifiers', 'contributorAffiliationNameIdentifiers'],
    'affiliation_name_identifier': ['affiliationNameIdentifier', 'contributorAffiliationNameIdentifier'],
    'affiliation_name_identifier_URI': ['affiliationNameIdentifierURI', 'contributorAffiliationURI'],
    'affiliations': ['creatorAffiliations', 'contributorAffiliations', 'affiliations'],
}
