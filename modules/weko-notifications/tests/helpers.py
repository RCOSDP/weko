...
def create_record(record_data, item_data):
    ...
    with db.session.begin_nested():
        ...
        parent=None
        doi = None
        if "iitem_30002_identifier_registration17" in record_data:
            doi_url = "https://doi.org/"+record_data["iitem_30002_identifier_registration17"]["attribute_value_mlt"][0]["subitem_identifier_reg_text"]
            try:
