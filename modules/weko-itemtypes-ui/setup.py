...
setup(
    ...
    entry_points={
        ...
        'invenio_assets.webpack': [
            'itemstypes_ui_css_style = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
            'itemstypes_ui_css_style_mapping = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
            'itemstypes_ui_css_style_rocrate_mapping = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
            'itemstypes_ui_js_dependencies_schema_editor = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
            'itemstypes_ui_js_schema_editor = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
            'itemstypes_ui_js_js = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
            'itemstypes_ui_js_js_property = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
            'itemstypes_ui_js_js_mapping = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
            'itemstypes_ui_js_js_rocrate_mapping = weko_itemtypes_ui.webpack:weko_itemtypes_ui',
        ],
