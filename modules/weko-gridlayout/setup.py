...
setup(
    ...
    entry_points={
        ...
        'invenio_assets.webpack': [
            'gridlayout_js_widget_design_js_lib = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_js_widget_design_reactjs_lib = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_js_widget_design_js = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_js_widget_setting_js = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_css_widget_design_css = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_css_widget_setting_css = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_css_katex_min_css = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_css_trumbowyg_css = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_js_katex_min_js = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_js_prop_types_js = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_js_react_quill_js = weko_gridlayout.webpack:weko_gridlayout',
            'gridlayout_js_trumbowyg_js_plugin = weko_gridlayout.webpack:weko_gridlayout',
        ],
