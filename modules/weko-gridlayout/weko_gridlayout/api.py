...
class WidgetMultiLangData(object):
    ...
    def build_object(cls, widget_items=None):
        ...
        try:
            ...
            data['lang_code'] = widget_items.get('lang_code')
            data['description_data'] = widget_items.get('description_data')
        except Exception as ex:
            current_app.logger.debug(ex)
            return
        return data
    ...
    def create(cls, widget_items=None):
        ...
        for k, v in widget_items.items():
            ...
            data = cls.build_object(new_data)
