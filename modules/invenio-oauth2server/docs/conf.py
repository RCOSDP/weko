...
html_theme_options = {
    ...
    'github_repo': 'invenio-oauth2server',
    'github_button': False,
    'github_banner': True,
    'show_powered_by': False,
    'extra_nav_links': {
        'invenio-oauth2server@GitHub': 'https://github.com/inveniosoftware/invenio-oauth2server',
        'invenio-oauth2server@PyPI': 'https://pypi.python.org/pypi/invenio-oauth2server/',
    }
}
...
htmlhelp_basename = 'invenio-oauth2server_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-oauth2server.tex', u'invenio-oauth2server Documentation',
   u'CERN', 'manual'),
]
