      ...
      React.useEffect(() => {
        ...
        const handleSave = async (e) => {
          ...
          try {
            ...
            alert(data.message || 'Successfully saved default conditions.');
            closeFilter();
        ...
        const handleReset = async (e) => {
          ...
          if (confirm('フィルタ条件を削除しますか？')) {
            try {
              ...
              alert(data.message || 'Successfully reset default conditions.');
              closeFilter();
              await refreshPage('/workspace/get_workspace_itemlist', 'GET');
            } catch (error) {
