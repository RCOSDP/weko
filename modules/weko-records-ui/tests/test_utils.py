...
def test_get_license_pdf(app):
    ...
    with app.test_request_context():
        get_license_pdf("license_note",item_metadata_json,pdf,file_item_id,footer_w,footer_h,cc_logo_xposition,item)
