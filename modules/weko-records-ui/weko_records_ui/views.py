...
import six
import werkzeug
from flask import Markup, Blueprint, abort, current_app, flash, jsonify, \
...
def default_view_method(pid, record, filename=None, template=None, **kwargs):
    ...
    for navi in record.navi:
        ...
        for path in path_arr:
            ...
            path_name_dict['ja'][path] = str(Markup.escape(index.index_name))
            path_name_dict['en'][path] = str(
                Markup.escape(index.index_name_english))
