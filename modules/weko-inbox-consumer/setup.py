...
g = {}
with open(os.path.join('weko_inbox_consumer', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
    version = g['__version__']

setup(
    name='weko-inbox-consumer',
    version=version,
    description=__doc__,
    ...
    url='https://github.com/RCOSDP/weko-inbox-consumer',
    packages=packages,
    zip_safe=False,
    ...
    entry_points={
        'invenio_base.apps': [
            'weko_inbox_consumer = weko_inbox_consumer:WekoInboxConsumer',
        ],
