...
$(function () {
    ...
    $('#demo-submit').on('click', function () {
        ...
        for (let idx = 0; idx < demoList.length; idx++) {
            ...
            // Read item info
            let idData = JSON.parse(demoList[idx]);
            let itemData = JSON.parse(demoList[++idx]);
            let indexData = JSON.parse(demoList[++idx]);
            ...
            if (idData['id']) {
                ...
                let index_url = redirect_url + "/" + idData['id'];
                let self_url = items_url + "/" + idData['id'];
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            for (var fileName in files) {
                                let file_url = data['links']['bucket'] + "/" + fileName;
                                $.ajax({
                                    type: "PUT",
                                    url: file_url,
                                    async: false,
                ...
                $.ajax({
                    ...
                    contentType: "application/json",
                    success: function (data) {
                        let index_url = redirect_url + "/" + data['id'];
                        let self_url = items_url + "/" + data['id'];
