...
htmlhelp_basename = 'weko-items-ui_namedoc'
...
latex_documents = [
    (master_doc, 'weko-items-ui.tex', u'weko-items-ui Documentation',
...
man_pages = [
    (master_doc, 'weko-items-ui', u'weko-items-ui Documentation',
     [author], 1)
]
