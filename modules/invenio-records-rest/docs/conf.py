...
html_theme_options = {
    ...
    "github_repo": "invenio-records-rest",
    "github_button": False,
    "github_banner": True,
...
htmlhelp_basename = "invenio-records-rest_namedoc"
...
latex_documents = [
    (
        master_doc,
        "invenio-records-rest.tex",
        "invenio-records-rest Documentation",
        "CERN",
        "manual",
    ),
]
...
intersphinx_mapping = {
    ...
    "invenio-indexer": ("https://invenio-indexer.readthedocs.io/en/latest/", None),
    "invenio-search": ("https://invenio-search.readthedocs.io/en/latest/", None),
    ...
    "invenio-records": ("https://invenio-records.readthedocs.io/en/latest/", None),
