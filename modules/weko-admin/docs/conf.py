...
html_theme_options = {
    ...
    'github_repo': 'weko-admin',
    'github_button': False,
    'github_banner': True,
    'show_powered_by': False,
    'extra_nav_links': {
        'weko-admin@GitHub': 'https://github.com/wekosoftware/weko-admin',
        'weko-admin@PyPI': 'https://pypi.python.org/pypi/weko-admin/',
    }
}
...
htmlhelp_basename = 'weko-admin_namedoc'
...
latex_documents = [
    (master_doc, 'weko-admin.tex', u'weko-admin Documentation',
