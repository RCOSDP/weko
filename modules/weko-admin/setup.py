...
setup(
    ...
    entry_points={
        ...
        'invenio_assets.webpack': [
            'admin_js_js = weko_theme.webpack:weko_admin',
            'admin_js_statistics_reactjs_lib = weko_theme.webpack:weko_admin',
            'admin_js_custom_report_js = weko_theme.webpack:weko_admin',
            'admin_js_search_management_js = weko_theme.webpack:weko_admin',
            'admin_js_react_bootstrap_js = weko_theme.webpack:weko_admin',
            'admin_js_stats_report_js = weko_theme.webpack:weko_admin',
            'admin_js_feedback_mail_js = weko_theme.webpack:weko_admin',
            'admin_js_log_analysis_js = weko_theme.webpack:weko_admin',
            'admin_css_date_picker_css = weko_theme.webpack:weko_admin',
            'admin_js_date_picker_js = weko_theme.webpack:weko_admin',
            'admin_css_css = weko_theme.webpack:weko_admin',
            'admin_css_weko_admin_quill_sknow_css = weko_theme.webpack:weko_admin',
            'admin_css_weko_admin_feedback_mail_css = weko_theme.webpack:weko_admin',
            'admin_js_admin_lte_js_dependecies = weko_theme.webpack:weko_admin',
            'admin_js_weko_admin_site_info_js = weko_theme.webpack:weko_admin',
            'admin_css_weko_admin_site_info_css = weko_theme.webpack:weko_admin',
            'admin_js_weko_admin_ng_js_tree_js = weko_theme.webpack:weko_admin',
            'admin_js_weko_admin_restricted_access_js = weko_theme.webpack:weko_admin',
            'admin_js_weko_admin_facet_search_js = weko_theme.webpack:weko_admin',
            'admin_js_reindex_elasticsearch_js = weko_theme.webpack:weko_admin',
        ],
        'invenio_db.models': [
