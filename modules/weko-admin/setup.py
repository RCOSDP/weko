...
setup(
    ...
    entry_points={
        ...
        'invenio_assets.webpack': [
            'admin_js_js = weko_theme.webpack:admin_js_js',
            'admin_js_statistics_reactjs_lib = weko_theme.webpack:admin_js_statistics_reactjs_lib',
            'admin_js_custom_report_js = weko_theme.webpack:admin_js_custom_report_js',
            'admin_js_search_management_js = weko_theme.webpack:admin_js_search_management_js',
            'admin_js_react_bootstrap_js = weko_theme.webpack:admin_js_react_bootstrap_js',
            'admin_js_stats_report_js = weko_theme.webpack:admin_js_stats_report_js',
            'admin_js_feedback_mail_js = weko_theme.webpack:admin_js_feedback_mail_js',
            'admin_js_log_analysis_js = weko_theme.webpack:admin_js_log_analysis_js',
            'admin_css_date_picker_css = weko_theme.webpack:admin_css_date_picker_css',
            'admin_js_date_picker_js = weko_theme.webpack:admin_js_date_picker_js',
            'admin_css_css = weko_theme.webpack:admin_css_css',
            'admin_css_weko_admin_quill_sknow_css = weko_theme.webpack:admin_css_weko_admin_quill_sknow_css',
            'admin_css_weko_admin_feedback_mail_css = weko_theme.webpack:admin_css_weko_admin_feedback_mail_css',
            'admin_js_admin_lte_js_dependecies = weko_theme.webpack:admin_js_admin_lte_js_dependecies',
            'admin_js_weko_admin_site_info_js = weko_theme.webpack:admin_js_weko_admin_site_info_js',
            'admin_css_weko_admin_site_info_css = weko_theme.webpack:admin_css_weko_admin_site_info_css',
            'admin_js_weko_admin_ng_js_tree_js = weko_theme.webpack:admin_js_weko_admin_ng_js_tree_js',
            'admin_js_weko_admin_restricted_access_js = weko_theme.webpack:admin_js_weko_admin_restricted_access_js',
            'admin_js_weko_admin_facet_search_js = weko_theme.webpack:admin_js_weko_admin_facet_search_js',
            'admin_js_reindex_elasticsearch_js = weko_theme.webpack:admin_js_reindex_elasticsearch_js',
        ],
        'invenio_db.models': [
