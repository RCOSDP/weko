...
WEKO_ADMIN_MANAGEMENT_OPTIONS = {
    ...
    'detail_condition': [
        ...
        {'id': 'type', 'contents': 'Resource Type', 'useable_status': True, 'mapping': ['Conference', 'Paper', 'Departmental', 'Bulletin',
         ...
         'check_val':[{'id': '0', 'contents': 'Conference Paper', 'checkStus': False},
                      {'id': '1',
                       'contents': 'Departmental Bulletin Paper',
                       'checkStus': False},
                      {'id': '2', 'contents': 'Journal Article', 'checkStus': False},
                      {'id': '3', 'contents': 'Article', 'checkStus': False},
                      {'id': '4', 'contents': 'Book', 'checkStus': False},
                      {'id': '6', 'contents': 'Presentation', 'checkStus': False},
                      {'id': '6', 'contents': 'Data or Dataset', 'checkStus': False},
                      {'id': '7', 'contents': 'Research Paper', 'checkStus': False},
                      {'id': '8',
                      ...
                      {'id': '10',
                       ...
                       'checkStus': False},
                      {'id': '11', 'contents': 'Software', 'checkStus': False},
                      ],
...
'BY-NC-SA', 'ANY', 'CC0', '3.0', '4.0', 'CC', 'BY-NC-ND'],
         'check_val':[
