...
WEKO_ADMIN_MANAGEMENT_OPTIONS = {
    ...
    'detail_condition': [
        ...
        {'id': 'filedate', 'contents': 'Contents Created Date',
         'contents_value': {'en': 'integer_EN_5', 'ja': 'integer_JA_5'},

         'useable_status': True, 'mapping': ['date'],
        ...
        {'id': 'id', 'contents': 'ID',
         ...
         'useable_status': True, 'mapping': ['identifier', 'URI', 'fullTextURL', 'selfDOI', 'ISBN', 'ISSN', 'NCID', 'pmid', 'doi', 'NAID', 'ichushi'],
        ...
        {'id': 'type', 'contents': 'Resource Type',
         'contents_value': {'en': 'integer_EN_5', 'ja': 'integer_JA_5'},
         'useable_status': True, 'mapping': ['Conference', 'Paper', 'Departmental', 'Bulletin',
        ...
        {'id': 'lang', 'contents': 'Language',
         'contents_value': {'en': 'integer_EN_5', 'ja': 'integer_JA_5'},

         'useable_status': True, 'mapping': ['Japanese', 'English', 'French', 'Italian', 'German', 'Spanish', 'Chinese', 'Russian', 'Latin', 'Malay', 'Esperanto', 'Arabic', 'Greek', 'Korean', 'Other'],
        ...
        {'id': 'version', 'contents': 'Author Version Flag',
         'contents_value': {'en': 'integer_EN_5', 'ja': 'integer_JA_5'},

         'useable_status': True, 'mapping': [],
         'options':[
        ...
        {'id': 'wid',
         ...
         'mappingFlg':False,
         'mappingName':''},
        {'id': 'iid', 'contents': 'Index', 'useable_status': True,
         'mapping': ['iid'],
         'check_val':[],
         'inputVal':'',
         'default_display': True, 'inputType': 'checkbox_list', 'inputVal': '', 'mappingFlg': False, 'mappingName': ''},
