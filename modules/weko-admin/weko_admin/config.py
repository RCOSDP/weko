...
WEKO_ADMIN_MANAGEMENT_OPTIONS = {
    ...
    'dlt_index_sort_options':[
        {'id': 'wtl_asc', 'contents': 'Title(asc)'},
        {'id': 'wtl_desc', 'contents': 'Title(desc)'},
        {'id': 'creator_asc', 'contents': 'Creator(asc)'},
        {'id': 'creator_desc', 'contents': 'Creator(desc)'},
        {'id': 'itemType_asc', 'contents': 'ItemType(asc)'},
        {'id': 'itemType_desc', 'contents': 'ItemType(desc)'},
        {'id': 'controlnumber_asc', 'contents': 'ID(asc)'},
        {'id': 'controlnumber_desc', 'contents': 'ID(desc)'},
        {'id': 'upd_asc', 'contents': 'Update(asc)'},
        {'id': 'upd_desc', 'contents': 'Update(desc)'},
        {'id': 'createdate_asc', 'contents': 'Create(asc)'},
        {'id': 'createdate_desc', 'contents': 'Create(desc)'},
        {'id': 'pyear_asc', 'contents': 'Date_of_Issued(asc)'},
        {'id': 'pyear_desc', 'contents': 'Date_of_Issued(desc)'},
        {'id': 'custom_sort_asc', 'contents': 'Custom(asc)'},
        {'id': 'custom_sort_desc', 'contents': 'Custom(desc)'},
    ],
    ...
    'sort_options':{
        ...
        'allow':[
            ...
            {'id': 'pyear_asc', 'contents': 'Date_of_Issued(asc/desc)'},
