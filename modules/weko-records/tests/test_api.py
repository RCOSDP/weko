...
class TestItemTypes:
    def test_update_attribute_options(app):
        ...
        a = {'add': 'New', 'key': 'key', 'items': [{'key': 'key[].creatorType', 'type': 'text', 'title': '作成者タイプ', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Type', 'ja': '作成者タイプ'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Type', 'ja': '作成者タイプ'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].nameIdentifiers', 'items': [{'key': 'key[].nameIdentifiers[].nameIdentifierScheme', 'type': 'select', 'title': '作成者識別子Scheme', 'isHide': False, 'required': False, 'titleMap': [], 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier Scheme', 'ja': '作成者識別子Scheme'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier Scheme', 'ja': '作成者識別子Scheme'}, 'isSpecifyNewline': False}, {'key': 'key[].nameIdentifiers[].nameIdentifierURI', 'type': 'text', 'title': '作成者識別子URI', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier URI', 'ja': '作成者識別子URI'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier URI', 'ja': '作成者識別子URI'}, 'isSpecifyNewline': False}, {'key': 'key[].nameIdentifiers[].nameIdentifier', 'type': 'text', 'title': '作成者識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorNames', 'items': [{'key': 'key[].creatorNames[].creatorName', 'type': 'text', 'title': '姓名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Name', 'ja': '姓名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Name', 'ja': '姓名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorNames[].creatorNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorNames[].creatorNameType', 'type': 'select', 'title': '名前タイプ', 'isHide': False, 'required': False, 'titleMap': [{'name': 'Personal', 'value': 'Personal'}, {'name': 'Organizational', 'value': 'Organizational'}], 'isShowList': False, 'title_i18n': {'en': 'Name Type', 'ja': '名前タイプ'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Name Type', 'ja': '名前タイプ'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者姓名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name', 'ja': '作成者姓名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name', 'ja': '作成者姓名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].familyNames', 'items': [{'key': 'key[].familyNames[].familyName', 'type': 'text', 'title': '姓', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Family Name', 'ja': '姓'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Family Name', 'ja': '姓'}, 'isSpecifyNewline': False}, {'key': 'key[].familyNames[].familyNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者姓', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Family Name', 'ja': '作成者姓'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Family Name', 'ja': '作成者姓'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].givenNames', 'items': [{'key': 'key[].givenNames[].givenName', 'type': 'text', 'title': '名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Given Name', 'ja': '名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Given Name', 'ja': '名'}, 'isSpecifyNewline': False}, {'key': 'key[].givenNames[].givenNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Given Name', 'ja': '作成者名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Given Name', 'ja': '作成者名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAlternatives', 'items': [{'key': 'key[].creatorAlternatives[].creatorAlternative', 'type': 'text', 'title': '別名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Alternative Name', 'ja': '別名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Alternative Name', 'ja': '別名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAlternatives[].creatorAlternativeLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者別名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Alternative Name', 'ja': '作成者別名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Alternative Name', 'ja': '作成者別名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAffiliations', 'items': [{'add': 'New', 'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers', 'items': [{'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifier', 'type': 'text', 'title': '所属機関識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier', 'ja': '所属機関識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier', 'ja': '所属機関識別子'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierScheme', 'type': 'select', 'title': '所属機関識別子Scheme', 'isHide': False, 'required': False, 'titleMap': [{'name': 'kakenhi', 'value': 'kakenhi'}, {'name': 'ISNI', 'value': 'ISNI'}, {'name': 'Ringgold', 'value': 'Ringgold'}, {'name': 'GRID', 'value': 'GRID'}], 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier Scheme', 'ja': '所属機関識別子Scheme'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier Scheme', 'ja': '所属機関識別子Scheme'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierURI', 'type': 'text', 'title': '所属機関識別子URI', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier URI', 'ja': '所属機関識別子URI'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier URI', 'ja': '所属機関識別子URI'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '所属機関識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifiers', 'ja': '所属機関識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifiers', 'ja': '所属機関識別子'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAffiliations[].affiliationNames', 'items': [{'key': 'key[].creatorAffiliations[].affiliationNames[].affiliationName', 'type': 'text', 'title': '所属機関名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name', 'ja': '所属機関名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name', 'ja': '所属機関名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNames[].affiliationNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '所属機関名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Names', 'ja': '所属機関名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Names', 'ja': '所属機関名'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者所属', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation', 'ja': '作成者所属'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation', 'ja': '作成者所属'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorMails', 'items': [{'key': 'key[].creatorMails[].creatorMail', 'type': 'text', 'title': 'メールアドレス', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Email Address', 'ja': 'メールアドレス'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Email Address', 'ja': 'メールアドレス'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者メールアドレス', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Email Address', 'ja': '作成者メールアドレス'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Email Address', 'ja': '作成者メールアドレス'}, 'isSpecifyNewline': False}, {'key': 'key[].authorInputButton', 'icon': 'glyphicon glyphicon-search', 'type': 'button', 'style': 'btn-default pull-right m-top-5', 'title': '著者DBから入力', 'isHide': False, 'onClick': "searchAuthor('key', true, form)", 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Enter from DB', 'ja': '著者DBから入力'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Enter from DB', 'ja': '著者DBから入力'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title_i18n': {'en': 'Creator', 'ja': '作成者'}}
        b = {'add': 'New', 'key': 'key', 'items': [{'key': 'key[].creatorType', 'type': 'text', 'title': '作成者タイプ', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Type', 'ja': '作成者タイプ'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Type', 'ja': '作成者タイプ'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].nameIdentifiers', 'items': [{'key': 'key[].nameIdentifiers[].nameIdentifierScheme', 'type': 'select', 'title': '作成者識別子Scheme', 'isHide': False, 'required': False, 'titleMap': [], 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier Scheme', 'ja': '作成者識別子Scheme'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier Scheme', 'ja': '作成者識別子Scheme'}, 'isSpecifyNewline': False}, {'key': 'key[].nameIdentifiers[].nameIdentifierURI', 'type': 'text', 'title': '作成者識別子URI', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier URI', 'ja': '作成者識別子URI'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier URI', 'ja': '作成者識別子URI'}, 'isSpecifyNewline': False}, {'key': 'key[].nameIdentifiers[].nameIdentifier', 'type': 'text', 'title': '作成者識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorNames', 'items': [{'key': 'key[].creatorNames[].creatorName', 'type': 'text', 'title': '姓名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Name', 'ja': '姓名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Name', 'ja': '姓名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorNames[].creatorNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorNames[].creatorNameType', 'type': 'select', 'title': '名前タイプ', 'isHide': False, 'required': False, 'titleMap': [{'name': 'Personal', 'value': 'Personal'}, {'name': 'Organizational', 'value': 'Organizational'}], 'isShowList': False, 'title_i18n': {'en': 'Name Type', 'ja': '名前タイプ'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Name Type', 'ja': '名前タイプ'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者姓名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name', 'ja': '作成者姓名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name', 'ja': '作成者姓名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].familyNames', 'items': [{'key': 'key[].familyNames[].familyName', 'type': 'text', 'title': '姓', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Family Name', 'ja': '姓'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Family Name', 'ja': '姓'}, 'isSpecifyNewline': False}, {'key': 'key[].familyNames[].familyNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者姓', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Family Name', 'ja': '作成者姓'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Family Name', 'ja': '作成者姓'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].givenNames', 'items': [{'key': 'key[].givenNames[].givenName', 'type': 'text', 'title': '名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Given Name', 'ja': '名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Given Name', 'ja': '名'}, 'isSpecifyNewline': False}, {'key': 'key[].givenNames[].givenNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Given Name', 'ja': '作成者名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Given Name', 'ja': '作成者名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAlternatives', 'items': [{'key': 'key[].creatorAlternatives[].creatorAlternative', 'type': 'text', 'title': '別名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Alternative Name', 'ja': '別名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Alternative Name', 'ja': '別名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAlternatives[].creatorAlternativeLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者別名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Alternative Name', 'ja': '作成者別名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Alternative Name', 'ja': '作成者別名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAffiliations', 'items': [{'add': 'New', 'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers', 'items': [{'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifier', 'type': 'text', 'title': '所属機関識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier', 'ja': '所属機関識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier', 'ja': '所属機関識別子'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierScheme', 'type': 'select', 'title': '所属機関識別子Scheme', 'isHide': False, 'required': False, 'titleMap': [{'name': 'kakenhi', 'value': 'kakenhi'}, {'name': 'ISNI', 'value': 'ISNI'}, {'name': 'Ringgold', 'value': 'Ringgold'}, {'name': 'GRID', 'value': 'GRID'}], 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier Scheme', 'ja': '所属機関識別子Scheme'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier Scheme', 'ja': '所属機関識別子Scheme'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierURI', 'type': 'text', 'title': '所属機関識別子URI', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier URI', 'ja': '所属機関識別子URI'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier URI', 'ja': '所属機関識別子URI'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '所属機関識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifiers', 'ja': '所属機関識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifiers', 'ja': '所属機関識別子'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAffiliations[].affiliationNames', 'items': [{'key': 'key[].creatorAffiliations[].affiliationNames[].affiliationName', 'type': 'text', 'title': '所属機関名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name', 'ja': '所属機関名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name', 'ja': '所属機関名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNames[].affiliationNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '所属機関名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Names', 'ja': '所属機関名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Names', 'ja': '所属機関名'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者所属', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation', 'ja': '作成者所属'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation', 'ja': '作成者所属'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorMails', 'items': [{'key': 'key[].creatorMails[].creatorMail', 'type': 'text', 'title': 'メールアドレス', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Email Address', 'ja': 'メールアドレス'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Email Address', 'ja': 'メールアドレス'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者メールアドレス', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Email Address', 'ja': '作成者メールアドレス'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Email Address', 'ja': '作成者メールアドレス'}, 'isSpecifyNewline': False}, {'key': 'key[].authorInputButton', 'icon': 'glyphicon glyphicon-search', 'type': 'button', 'style': 'btn-default pull-right m-top-5', 'title': '著者DBから入力', 'isHide': False, 'onClick': "searchAuthor('key', true, form)", 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Enter from DB', 'ja': '著者DBから入力'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Enter from DB', 'ja': '著者DBから入力'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title_i18n': {'en': 'Creator', 'ja': '作成者'}}
        expected_dict = {'add': 'New', 'key': 'key', 'items': [{'key': 'key[].creatorType', 'type': 'text', 'title': '作成者タイプ', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Type', 'ja': '作成者タイプ'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Type', 'ja': '作成者タイプ'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].nameIdentifiers', 'items': [{'key': 'key[].nameIdentifiers[].nameIdentifierScheme', 'type': 'select', 'title': '作成者識別子Scheme', 'isHide': False, 'required': False, 'titleMap': [], 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier Scheme', 'ja': '作成者識別子Scheme'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier Scheme', 'ja': '作成者識別子Scheme'}, 'isSpecifyNewline': False}, {'key': 'key[].nameIdentifiers[].nameIdentifierURI', 'type': 'text', 'title': '作成者識別子URI', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier URI', 'ja': '作成者識別子URI'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier URI', 'ja': '作成者識別子URI'}, 'isSpecifyNewline': False}, {'key': 'key[].nameIdentifiers[].nameIdentifier', 'type': 'text', 'title': '作成者識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name Identifier', 'ja': '作成者識別子'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorNames', 'items': [{'key': 'key[].creatorNames[].creatorName', 'type': 'text', 'title': '姓名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Name', 'ja': '姓名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Name', 'ja': '姓名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorNames[].creatorNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorNames[].creatorNameType', 'type': 'select', 'title': '名前タイプ', 'isHide': False, 'required': False, 'titleMap': [{'name': 'Personal', 'value': 'Personal'}, {'name': 'Organizational', 'value': 'Organizational'}], 'isShowList': False, 'title_i18n': {'en': 'Name Type', 'ja': '名前タイプ'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Name Type', 'ja': '名前タイプ'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者姓名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Name', 'ja': '作成者姓名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Name', 'ja': '作成者姓名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].familyNames', 'items': [{'key': 'key[].familyNames[].familyName', 'type': 'text', 'title': '姓', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Family Name', 'ja': '姓'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Family Name', 'ja': '姓'}, 'isSpecifyNewline': False}, {'key': 'key[].familyNames[].familyNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者姓', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Family Name', 'ja': '作成者姓'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Family Name', 'ja': '作成者姓'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].givenNames', 'items': [{'key': 'key[].givenNames[].givenName', 'type': 'text', 'title': '名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Given Name', 'ja': '名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Given Name', 'ja': '名'}, 'isSpecifyNewline': False}, {'key': 'key[].givenNames[].givenNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Given Name', 'ja': '作成者名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Given Name', 'ja': '作成者名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAlternatives', 'items': [{'key': 'key[].creatorAlternatives[].creatorAlternative', 'type': 'text', 'title': '別名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Alternative Name', 'ja': '別名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Alternative Name', 'ja': '別名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAlternatives[].creatorAlternativeLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者別名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Alternative Name', 'ja': '作成者別名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Alternative Name', 'ja': '作成者別名'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAffiliations', 'items': [{'add': 'New', 'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers', 'items': [{'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifier', 'type': 'text', 'title': '所属機関識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier', 'ja': '所属機関識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier', 'ja': '所属機関識別子'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierScheme', 'type': 'select', 'title': '所属機関識別子Scheme', 'isHide': False, 'required': False, 'titleMap': [{'name': 'kakenhi', 'value': 'kakenhi'}, {'name': 'ISNI', 'value': 'ISNI'}, {'name': 'Ringgold', 'value': 'Ringgold'}, {'name': 'GRID', 'value': 'GRID'}], 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier Scheme', 'ja': '所属機関識別子Scheme'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier Scheme', 'ja': '所属機関識別子Scheme'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNameIdentifiers[].affiliationNameIdentifierURI', 'type': 'text', 'title': '所属機関識別子URI', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifier URI', 'ja': '所属機関識別子URI'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifier URI', 'ja': '所属機関識別子URI'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '所属機関識別子', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name Identifiers', 'ja': '所属機関識別子'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name Identifiers', 'ja': '所属機関識別子'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorAffiliations[].affiliationNames', 'items': [{'key': 'key[].creatorAffiliations[].affiliationNames[].affiliationName', 'type': 'text', 'title': '所属機関名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Name', 'ja': '所属機関名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Name', 'ja': '所属機関名'}, 'isSpecifyNewline': False}, {'key': 'key[].creatorAffiliations[].affiliationNames[].affiliationNameLang', 'type': 'select', 'title': '言語', 'isHide': False, 'required': False, 'titleMap': [{'name': 'ja', 'value': 'ja'}, {'name': 'ja-Kana', 'value': 'ja-Kana'}, {'name': 'ja-Latn', 'value': 'ja-Latn'}, {'name': 'en', 'value': 'en'}, {'name': 'fr', 'value': 'fr'}, {'name': 'it', 'value': 'it'}, {'name': 'de', 'value': 'de'}, {'name': 'es', 'value': 'es'}, {'name': 'zh-cn', 'value': 'zh-cn'}, {'name': 'zh-tw', 'value': 'zh-tw'}, {'name': 'ru', 'value': 'ru'}, {'name': 'la', 'value': 'la'}, {'name': 'ms', 'value': 'ms'}, {'name': 'eo', 'value': 'eo'}, {'name': 'ar', 'value': 'ar'}, {'name': 'el', 'value': 'el'}, {'name': 'ko', 'value': 'ko'}], 'isShowList': False, 'title_i18n': {'en': 'Language', 'ja': '言語'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Language', 'ja': '言語'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '所属機関名', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation Names', 'ja': '所属機関名'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation Names', 'ja': '所属機関名'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者所属', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Affiliation', 'ja': '作成者所属'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Affiliation', 'ja': '作成者所属'}, 'isSpecifyNewline': False}, {'add': 'New', 'key': 'key[].creatorMails', 'items': [{'key': 'key[].creatorMails[].creatorMail', 'type': 'text', 'title': 'メールアドレス', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Email Address', 'ja': 'メールアドレス'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Email Address', 'ja': 'メールアドレス'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title': '作成者メールアドレス', 'isHide': False, 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Creator Email Address', 'ja': '作成者メールアドレス'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Creator Email Address', 'ja': '作成者メールアドレス'}, 'isSpecifyNewline': False}, {'key': 'key[].authorInputButton', 'icon': 'glyphicon glyphicon-search', 'type': 'button', 'style': 'btn-default pull-right m-top-5', 'title': '著者DBから入力', 'isHide': False, 'onClick': "searchAuthor('key', true, form)", 'required': False, 'isShowList': False, 'title_i18n': {'en': 'Enter from DB', 'ja': '著者DBから入力'}, 'isNonDisplay': False, 'title_i18n_temp': {'en': 'Enter from DB', 'ja': '著者DBから入力'}, 'isSpecifyNewline': False}], 'style': {'add': 'btn-success'}, 'title_i18n': {'en': 'Creator', 'ja': '作成者'}}
        ItemTypes.update_attribute_options(a,b)
        TestCase().assertDictEqual(b, expected_dict)
