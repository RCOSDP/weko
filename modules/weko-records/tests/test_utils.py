...
def test_json_loader(
    app, db, item_type, item_type2, item_type_mapping2, records, users, mocker
):
    ...
    item_type_scheme = {
        "properties": {
            ...
            "item_4": {
                "title": "item_4",
                "type": "object",
                "properties": {"item_4_1": {"title": "item_4_1", "type": "string"}},
            },
            "item_5": {
                "title": "item_5",
                "type": "array",
            ...
            "item_6": {
                ...
                "type": "array",
                "items": {
                    "properties": {"item_6_1": {"title": "item_6_1", "type": "string"}}
                },
            },
            "item_7": {
                "title": "item_7",
    ...
    item_type_mapping = {
        ...
        "item_4": {"jpcoar_mapping": {"item_4": {"@value": "item_4_1"}}},
        "item_5": {"jpcoar_mapping": {"item_5": {"@value": "filename"}}},
        "item_6": {"jpcoar_mapping": {"item_6": {"@value": "item_6_1"}}},
        "item_7": {
            "jpcoar_mapping": {
                "creator1": {
                    "nameIdentifier": {
    ...
    data2 = {"$schema": "http://schema/1/A-test"}
    ...
    data3 = {
        ...
        "item_7": [
            ...
            {
                "nameIdentifiers": [
                    {"nameIdentifierScheme": "WEKO", "nameIdentifier": "1234"}
                ]
            },
        ],
        "item_8": {
            "nameIdentifiers": [
                {"nameIdentifierScheme": "WEKO", "nameIdentifier": "5678"}
            ]
        },
    }
    ...
    assert dc == OrderedDict(
        [
            (
                "pubdate",
                {"attribute_name": "Publish Date", "attribute_value": "2023-08-08"},
            ),
            ("item_1", {"attribute_name": "item_1", "attribute_value": "item_1_v"}),
            ("item_2", {"attribute_name": "item_2", "attribute_value": ""}),
            (
                "item_3",
                {
                    "attribute_name": "item_3",
                    "attribute_type": "creator",
                    "attribute_value_mlt": [{"item_3_1": "item_3_1_v"}],
                },
            ),
            (
                "item_4",
                {
                    "attribute_name": "item_4",
                    "attribute_value_mlt": [{"item_4_1": "item_4_1_v"}],
                },
            ),
            (
                "item_5",
                {
                    "attribute_name": "item_5",
                    "attribute_type": "file",
                    "attribute_value_mlt": [{"filename": "item_5"}],
                },
            ),
            ("item_6", {"attribute_name": "item_6", "attribute_value_mlt": [{}]}),
            (
                "item_7",
                {
                    "attribute_name": "item_7",
                    "attribute_value_mlt": [
                        {},
                        {
                            "nameIdentifiers": [
            ...
            ("item_type_id", "3"),
            ("control_number", "1"),
            ("author_link", ["1234", "5678"]),
            ("_oai", {"id": "1"}),
        ]
    )
    assert jrc == {
        "item_4": ["item_4_1_v"],
        "creator1": {"nameIdentifier": ["1234", "5678"]},
        "item_5": ["item_5"],
        "item_3": ["item_3_1_v"],
        "control_number": "1",
        "_oai": {"id": "1"},
        ...
        assert dc == OrderedDict(
            [
                ...
                (
                    "item_6",
                    {
                        "attribute_name": "item_6",
                        "attribute_value_mlt": [{"item_6_1": "item_6_1_v"}],
                    },
                ),
                (
                    "item_7",
                ...
                [
                    (
                        "pubdate",
                        {
                            ...
                            "attribute_value": "2023-08-08",
                        },
                    ),
                    (
                        "item_1",
                        {"attribute_name": "item_1", "attribute_value": "item_1_v"},
                    ),
                    (
                        "item_2",
                        {"attribute_name": "item_2", "attribute_value": "item_2_v"},
                    ),
                    (
                        "item_3",
                        {
...
def test_copy_field_test(app, meta, k_v):
    ...
    with patch("weko_records.utils.get_values_from_dict", return_value=[1, 2, 3, 4, 5]):
        with patch(
            "weko_records.utils.convert_range_value", return_value=[1, 2, 3, 4, 5]
        ):
...
def test_convert_date_range_value():
    assert convert_date_range_value("1762-01-26/1762-02-23") == {
        "gte": "1762-01-26",
        "lte": "1762-02-23",
    }
    assert convert_date_range_value("2000-01-01/2021-03-30") == {
        "gte": "2000-01-01",
        "lte": "2021-03-30",
    }
    assert convert_date_range_value(" 1762-01-26/1762-02-23 ") == {
    ...
    assert convert_date_range_value("2000-01/2021-03") == {
        "gte": "2000-01",
        "lte": "2021-03",
    }
    assert convert_date_range_value("2000/2021") == {"gte": "2000", "lte": "2021"}
    assert convert_date_range_value("2000-01-01") == {
        "gte": "2000-01-01",
        "lte": "2000-01-01",
    }
    assert convert_date_range_value("2000-01") == {"gte": "2000-01", "lte": "2000-01"}
    assert convert_date_range_value("2000") == {"gte": "2000", "lte": "2000"}
    assert convert_date_range_value("2000-01-01", "2000-12-01") == {
        "gte": "2000-01-01",
        "lte": "2000-12-01",
    }
    assert convert_date_range_value(None, "2000-12-01") == {
        "gte": "2000-12-01",
        "lte": "2000-12-01",
    }
    assert convert_date_range_value("1979-01-01/1960-01-01") == {
        "gte": "1960-01-01",
        "lte": "1979-01-01",
    }
    assert convert_date_range_value("1979-1-1/1960-1-1") == {
        "gte": "1960-1-1",
        "lte": "1979-1-1",
    }
    assert convert_date_range_value("2021/12/1") == {
        "gte": "2021-12-1",
        "lte": "2021-12-1",
    }
...
def test_makeDateRangeValue():
    assert makeDateRangeValue("1979", "1960") == {"gte": "1960", "lte": "1979"}
...
def test_get_values_from_dict(app, meta, jsonpath):
    assert get_values_from_dict(meta[0], jsonpath[0], "json") == ["寄与者", "Contributor"]
    assert get_values_from_dict(meta[0], jsonpath[1], "json") == [
        "2000-01-01/2021-03-30"
    ]
    assert get_values_from_dict(meta[0], jsonpath[2], "json") == [
        "概要",
        "その他",
        "materials: text",
    ]
    assert get_values_from_dict(meta[0], jsonpath[3], "json") == [
        "その他",
        "materials: text",
    ]
    assert get_values_from_dict(meta[0], jsonpath[3], "xml") == None
...
def test_copy_value_json_path(meta, jsonpath):
    ...
    assert copy_value_json_path(meta[0], jsonpath[1]) == ["2000-01-01/2021-03-30"]
    assert copy_value_json_path(meta[0], jsonpath[2]) == [
        "概要",
        "その他",
        "materials: text",
    ]
    assert copy_value_json_path(meta[0], jsonpath[3]) == ["その他", "materials: text"]
...
def test_copy_values_json_path(meta, jsonpath):
    assert copy_values_json_path(meta[0], jsonpath[0]) == ["寄与者", "Contributor"]
    assert copy_values_json_path(meta[0], jsonpath[1]) == ["2000-01-01/2021-03-30"]
    assert copy_values_json_path(meta[0], jsonpath[2]) == [
        "概要",
        "その他",
        "materials: text",
    ]
    assert copy_values_json_path(meta[0], jsonpath[3]) == ["その他", "materials: text"]
...
def test_set_timestamp():
    ...
    assert _jrc == {
        "_created": "2000-01-01T00:00:00+00:00",
        "_updated": "2000-12-31T00:00:00+00:00",
    }
...
def test_sort_records():
    _form = [
        {
            "key": "item_1",
            "title": "item_1_title",
            "title_i18n": {"ja": "ja_item_1_title", "en": "en_item_1_title"},
        },
        {
            "key": "item_2",
            "title": "item_2_title",
            "title_i18n": {"ja": "ja_item_2_title", "en": "en_item_2_title"},
        },
    ]
    _records1 = {
    ...
    _records2 = [{"item_2": "item_2_value", "item_1": "item_1_value"}]
...
def test_sort_op():
    ...
    _record1 = {"$schema": "http://nii.co.jp/1", "old_item_1": "item_1_value"}
    _record2 = [{"item_2": "item_2_value", "item_1": "item_1_value"}]
    _record3 = {
        "$schema": "http://nii.co.jp/1",
    ...
    assert res == {
        "old_item_2": {"index": 2, "key2": "item_2_value"},
...
def test_get_all_items():
    _nlst = [
        {"subitem_1": "en_value", "subitem_1_lang": "en"},
    ...
    assert res == [
        [{"item_1.subitem_1": "en_value", "item_1.subitem_1_lang": "en"}],
        [{"item_1.subitem_1": "ja_value", "item_1.subitem_1_lang": "ja"}],
    ]
...
@pytest.mark.asyncio
async def test_sort_meta_data_by_options(
    i18n_app, db, admin_settings, mocker, render, form, mapping, hit, licence
):
    import asyncio

    mocker.patch(
        "weko_records_ui.permissions.check_file_download_permission", return_value=True
    )
    ...
    item_type_mapping = Mapping.create(
        item_type_id=item_type.id, mapping=json_data(mapping)
    )
    record_hit = json_data(hit)
    settings = AdminSettings.get("items_display_settings")
    if not licence:
        i18n_app.config.update(WEKO_RECORDS_UI_LICENSE_DICT=False)
...
async def test_sort_meta_data_by_options_exception(i18n_app, db, admin_settings):
    record_hit = {"_source": {"item_item_id": "", "_item_metadata": {}}}
    _item_type_name = ItemTypeName(name="test")
    item_type = ItemTypes.create(
        name="test",
        item_type_name=_item_type_name,
    ...
    item_type_mapping = Mapping.create(item_type_id=item_type.id, mapping={})
    settings = AdminSettings.get("items_display_settings")
    with patch("weko_records.serializers.utils.get_mapping", side_effect=Exception):
        await sort_meta_data_by_options(
            record_hit, settings, item_type_mapping, item_type
        )
...
async def test_sort_meta_data_by_options_sample_1(i18n_app, db, admin_settings):
    ...
    with patch("weko_records.serializers.utils.get_mapping", return_value=data1):
        with patch(
            "weko_search_ui.utils.get_data_by_property", return_value=("1", "2")
        ):
            await sort_meta_data_by_options(
                record_hit, settings, item_type_mapping, item_type
            )
            ...
            record_hit_2["_source"]["_item_metadata"]["item_type_id"][
                "attribute_value_mlt"
            ][0]["version_id"] = ""
            record_hit_2["_source"]["_item_metadata"]["item_type_id"][
                "attribute_value_mlt"
            ...
            record_hit_2["_source"]["_item_metadata"]["item_type_id"][
                "attribute_value_mlt"
            ][0]["version_id"] = "version_id_9999"
            record_hit_2["_source"]["_item_metadata"]["item_type_id"][
                "attribute_value_mlt"
            ][0]["url"]["label"] = "label_9999"
            ...
            record_hit_2["_source"]["_item_metadata"]["item_type_id"][
                "attribute_value_mlt"
            ][0]["subitem_thumbnail"] = [{"thumbnail_label": "thumbnail_label_9999"}]
            ...
            del record_hit_2["_source"]["_item_metadata"]["item_type_id"][
                "attribute_value_mlt"
            ][0]["subitem_thumbnail"]
...
def test_set_file_date():
    ...
    solst = [
        [
            "item_1617187187528[].subitem_1599711813532",
            "Conference Country",
            "開催国",
            {
                "required": False,
        ...
        [
            "item_1617605131499[].url.objectType",
            "オブジェクトタイプ",
            "オブジェクトタイプ",
            {
                "required": False,
        ...
        [
            "item_1617605131499[].filesize[].value",
            "サイズ",
            "サイズ",
            {
                "required": False,
        ...
        [
            "item_1617605131499[].fileDate[].fileDateType",
            "日付タイプ",
            "日付タイプ",
            {
                "required": False,
        ...
        [
            "item_1617605131499[].displaytype",
            "表示形式",
            "表示形式",
            {
                "required": False,
        ...
        [
            "item_1617605131499[].licensetype",
            "ライセンス",
            "ライセンス",
            {
                "required": False,
        ...
        [
            "item_1617605131499[].licensefree",
            "",
            "自由ライセンス",
            {
                "required": False,
    ...
    metadata = [
        {
            "url": {"url": "https://weko3.example.org/record/79/files/open_access.png"},
            "date": [{"dateType": "Available", "dateValue": "2023-09-05"}],
            "format": "image/png",
            "fileDate": [{"fileDateType": "Accepted", "fileDateValue": "2023-09-02"}],
            "filename": "open_access.png",
            "filesize": [{"value": "98 KB"}],
            "mimetype": "image/png",
            "version_id": "5fc2d597-b658-4ae9-8ee5-8c3933eb0523",
            "is_thumbnail": False,
            "future_date_message": "",
    ...
    attr_lst = [
        [
            [
                ...
                [
                    {
                        "本文URL": [
                            [
                                [
                                    {
                                        "本文URL": "https://weko3.example.org/record/79/files/open_access.png"
                                    }
                                ]
                            ]
                        ]
                ...
                [{"フォーマット": "image/png"}],
                [{"サイズ": [[[[{"サイズ": "98 KB"}]]]]}],
                [{"日付": [[[[{"日付タイプ": "Accepted"}], [{"日付": "2023-09-02"}]]]]}],
            ]
        ]
    ]
    test = [
...
def test_get_attribute_value_all_items(app):
    ...
    assert res == [
        [[[{"en_item_1_title": "en_value"}], [{"en_item_1_lang": "en"}]]],
        [[[{"en_item_1_title": "ja_value"}], [{"en_item_1_lang": "ja"}]]],
    ]
...
def test_check_input_value():
    res = check_input_value(
        {"key": {"input_value": "same"}}, {"key": {"input_value": "same"}}
    )
    assert res == False
    res = check_input_value(
        {"key": {"input_value": "old"}}, {"key": {"input_value": "new"}}
    )
    assert res == True
...
def test_remove_multiple():
    _schema = {
        "properties": {
            "item_1": {"maxItems": 99, "minItems": 1, "title": "title_1"},
            "item_2": {
                "maxItems": 99,
                "minItems": 1,
                "items": [
...
def test_check_to_upgrade_version(app):
    _old_render = {
        ...
        "table_row_map": {
            "schema": {
                "properties": {
                    "item_1": {"type": "string", "title": "item_1", "format": "text"}
                }
            }
        },
        "table_row": ["1"],
    ...
    _new_render = {
        ...
        "table_row_map": {
            "schema": {
                "properties": {
                    "item_2": {"type": "string", "title": "item_2", "format": "text"}
                }
            }
        },
        "table_row": ["2"],
...
def test_selected_value_by_language(app, meta):
    ...
    res = selected_value_by_language(
        ["ja", "en"], ["タイトル日本語", "Title"], _lang_id, _val_id, "en", meta[0]
    )
    assert res == "Title"
    ...
    res = selected_value_by_language(
        ["en"], ["Creator"], _lang_id, _val_id, "en", meta[0]
    )
    assert res == "作者"
    with patch("weko_records.utils.check_info_in_metadata", return_value="en"):
        res = selected_value_by_language(
            ["ja-Latn"], ["ja-Latn"], _lang_id, _val_id, "en", meta[0]
        )
        assert res == "en"
...
def test_selected_value_by_language_2(app, meta):
    ...
    with patch("weko_records.utils.check_info_in_metadata", return_value="en"):
        res = selected_value_by_language(
            ["en"], ["ja"], _lang_id, _val_id, "ja", meta[0]
        )
        assert res == "en"
...
def test_selected_value_by_language_3(app):
    ...
    meta = {
        "item_titles": {
            "attribute_name": "タイトル",
            "attribute_value_mlt": [
                {"subitem_title": "title_with_nolang"},
                {"subitem_title": "title_en", "subitem_title_language": "en"},
            ],
        }
    }
    res = selected_value_by_language(
        ["en"], ["title_with_nolang", "title_en"], _lang_id, _val_id, "ja", meta
    )
    assert res != "title_en"
    ...
    with patch("weko_records.utils.check_info_in_metadata", return_value="en"):
        res = selected_value_by_language(
            ["ja-Latn"], ["ja-Latn"], _lang_id, _val_id, "en", meta
        )
        assert res == "en"
...
# def check_info_in_metadata(str_key_lang, str_key_val, str_lang, metadata):
# .tox/c1/bin/pytest --cov=weko_records tests/test_utils.py::test_check_info_in_metadata_issues44590 -v -s -vv --cov-branch --cov-report=term --cov-config=tox.ini --basetemp=/code/modules/weko-records/.tox/c1/tmp
def test_check_info_in_metadata_issues44590(app):
    _str_key_lang = "item_1617186331708.subitem_title_language"
    _str_key_val = "item_1617186331708.subitem_title"
    _str_lang = "ja"
    _meta = {
        "_item_metadata": {
            "item_1617186331708": {
                ...
                "attribute_value_mlt": [
                    {"subitem_title": "たいとる", "subitem_title_language": "ja"},
                    {"subitem_title": "title", "subitem_title_language": "en"}
                ],
            }}}
    
    res = check_info_in_metadata(_str_key_lang, _str_key_val, _str_lang, _meta)
    assert res == "たいとる"
    ...
    _str_key_lang = "item_1617186331708.=ja"
    _str_key_val = "item_1617186331708.subitem_title"
    _str_lang = "ja"
    res = check_info_in_metadata(_str_key_lang, _str_key_val, _str_lang, _meta)
    assert res == "たいとる"

    _str_key_lang = "item_1617186331708.=en"
    _str_key_val = "item_1617186331708.subitem_title"
    _str_lang = "en"
    res = check_info_in_metadata(_str_key_lang, _str_key_val, _str_lang, _meta)
    assert res == "title"
...
def test_get_value_and_lang_by_key(app):
    ...
    data_result, stt_key = get_value_and_lang_by_key(
        "item_1.subitem_1", _data_json, {}, []
    )
    assert data_result == {}
    assert stt_key == []
    data_result, stt_key = get_value_and_lang_by_key(
        "item_1.subitem_1.subitem_2", _data_json, {}, []
    )
    assert data_result == {
        "item_1.subitem_1": {
            "lang": ["lang1", "lang2"],
            "lang_id": "item_1.subitem_1.subitem_2",
        }
    }
    assert stt_key == ["item_1.subitem_1"]
    data_result, stt_key = get_value_and_lang_by_key(
        "item_2.subitem_1.subitem_2", _data_json, data_result, stt_key
    )
    assert data_result == {
        "item_1.subitem_1": {
            "lang": ["lang1", "lang2"],
        ...
        "item_2.subitem_1": {
            "item_2.subitem_1.subitem_2": {"value": ["title1", "title2"]},
...
def test_get_value_by_selected_lang(app):
    ...
    _source_title2 = {"None Language": "no_lang_test", "id": "id_test", "en": "en_test"}
    _source_title3 = {"None Language": "no_lang_test", "ja": "ja_test", "id": "id_test"}
    _source_title4 = {"None Language": "no_lang_test"}
    _source_title5 = {
        "ja": "ja_test",
        "en": "en_test",
        "id": "id_test",
...
def test_get_show_list_author(i18n_app):
    _solst_dict_array = [
        {
            ...
            "option": {"show_list": True, "hide": False},
            "parent_option": {"show_list": True, "hide": False},
        },
        {
            "key": "create.creatorNames[].creatorNameLang",
            "option": {"show_list": False, "hide": True},
            "parent_option": {"show_list": False, "hide": True},
        },
        {
    ...
    _creates = [
        {
            "creatorNames": [
                {"creatorName": "ja_name", "creatorNameLang": "ja"},
                {"creatorName": "en_name", "creatorNameLang": "en"},
            ...
            "familyNames": [
                ...
                {"familyName": "en_fname", "familyNameLang": "en"},
            ],
            "creatorMails": [{"creatorMail": "nii@mail.co.jp"}],
        }
    ]
...
def test_get_show_list_author_test0(i18n_app):
    solst_dict_array = [
        ...
        },
        {
            ...
            "value": "0-private-nooai-guest-4-0-public-oai-guest-1-ja-,- 0-private-nooai-guest-4-0-public-oai-guest-1-en",
        },
        {
        ...
        },
        {
            ...
            "value": "Alternative Title-,- Alternative Title",
        },
        {
        ...
        },
        {
            ...
            "title": "作成者識別子Scheme",
            "title_ja": "Creator Identifier Scheme",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
            ...
            "parent_option": {
                "required": False,
                "show_list": True,
                "specify_newline": True,
                "hide": False,
            },
            "value": "WEKO-,- ORCID-,- CiNii-,- KAKEN2-,- ORCID-,- CiNii-,- KAKEN2-,- ORCID-,- CiNii-,- KAKEN2",
        },
        {
            "key": "item_1617186419668.nameIdentifiers.nameIdentifierURI",
            "title": "作成者識別子URI",
            "title_ja": "Creator Identifier URI",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
            ...
            "value": "https://orcid.org/-,- https://ci.nii.ac.jp/-,- https://nrid.nii.ac.jp/nrid/xxxxxxx-,- https://orcid.org/yyyyyy-,- https://ci.nii.ac.jp/author/yyyyyy-,- https://nrid.nii.ac.jp/nrid/yyyyyy-,- https://orcid.org/zzzzzzz-,- https://ci.nii.ac.jp/author/zzzzzzz-,- https://kaken.nii.ac.jp/",
        },
        {
            ...
            "value": "4-,- xxxxxxx-,- xxxxxxx-,- xxxxxxx-,- yyyyyy-,- yyyyyy-,- yyyyyy-,- zzzzzzz-,- zzzzzzz-,- zzzzzzz",
        },
        {
            "key": "item_1617186419668.creatorNames",
            "title": "作成者姓名",
            "title_ja": "Creator Name",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "value": "情報, 太郎-,- ジョウホウ\t タロウ-,- Joho\t Taro-,- 情報, 太郎-,- ジョウホウ\t タロウ-,- Joho\t Taro-,- 情報, 太郎-,- ジョウホウ\t タロウ-,- Joho\t Taro",
        },
        {
            ...
            "value": "ja-,- ja-Kana-,- en-,- ja-,- ja-Kana-,- en-,- ja-,- ja-Kana-,- en",
        },
        {
            "key": "item_1617186419668.familyNames",
            "title": "作成者姓",
            "title_ja": "Creator Family Name",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "value": "情報-,- ジョウホウ-,- Joho-,- 情報-,- ジョウホウ-,- Joho-,- 情報-,- ジョウホウ-,- Joho",
        },
        {
        ...
        },
        {
            ...
            "value": "太郎-,- タロウ-,- Taro-,- 太郎-,- タロウ-,- Taro-,- 太郎-,- タロウ-,- Taro",
        },
        {
        ...
        },
        {
            ...
            "title": "作成者別名",
            "title_ja": "Creator Alternative Name",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "作成者メールアドレス",
            "title_ja": "Creator Email Address",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "value": "wekosoftware@nii.ac.jp-,- wekosoftware@nii.ac.jp-,- wekosoftware@nii.ac.jp",
        },
        {
            "key": "item_1617186419668.creatorAffiliations",
            "title": "作成者所属",
            "title_ja": "Affiliation Name Identifier",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "所属機関識別子URI",
            "title_ja": "Affiliation Name Identifier URI",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
            ...
            "value": "http://isni.org/isni/0000000121691048",
        },
        {
            "key": "item_1617186419668.creatorAffiliations.affiliationNames",
            "title": "所属機関名",
            "title_ja": "Affiliation Name",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "寄与者識別子",
            "title_ja": "Contributor Identifier",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "寄与者識別子Scheme",
            "title_ja": "Contributor Identifier Scheme",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
            ...
            "value": "ORCID-,- CiNii-,- KAKEN2",
        },
        {
            "key": "item_1617349709064.nameIdentifiers.nameIdentifierURI",
            "title": "寄与者識別子URI",
            "title_ja": "Contributor Identifier URI",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
            ...
            "value": "https://orcid.org/-,- https://ci.nii.ac.jp/-,- https://kaken.nii.ac.jp/",
        },
        {
            ...
            "value": "xxxxxxx-,- xxxxxxx-,- xxxxxxx",
        },
        {
            "key": "item_1617349709064.contributorNames",
            "title": "寄与者姓名",
            "title_ja": "Contributor Name",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "value": "情報, 太郎-,- ジョウホウ\t タロウ-,- Joho\t Taro",
        },
        {
        ...
        },
        {
            ...
            "title": "寄与者姓",
            "title_ja": "Contributor Family Name",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "寄与者名",
            "title_ja": "Contributor Given Name",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "寄与者別名",
            "title_ja": "Contributor Alternative Name",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "寄与者メールアドレス",
            "title_ja": "Contributor Email Address",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "権利情報Resource",
            "title_ja": "Rights Information Resource",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "value": "Rights Information",
        },
        {
            "key": "item_1617610673286",
            "title": "Rights Holder",
            "title_ja": "Rights Holder",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "権利者識別子",
            "title_ja": "Right Holder Identifier",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "権利者識別子Scheme",
            "title_ja": "Right Holder Identifier Scheme",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "権利者識別子URI",
            "title_ja": "Right Holder Identifier URI",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "資源タイプ識別子",
            "title_ja": "Resource Type Identifier",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
            ...
            "value": "http://purl.org/coar/resource_type/c_5794",
        },
        {
        ...
        },
        {
            ...
            "title": "出版タイプResource",
            "title_ja": "Version Type Resource",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
            ...
            "value": "http://purl.org/coar/version/c_b1a7d7d4d402bcce",
        },
        {
        ...
        },
        {
            ...
            "title_ja": "Identifier Registration",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "ID登録タイプ",
            "title_ja": "Identifier Registration Type",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "助成機関識別子タイプ",
            "title_ja": "Funder Identifier Type",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title": "収録物識別子タイプ",
            "title_ja": "Source Identifier Type",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "Bibliographic Information",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "Degree Grantor Name Identifier",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "Degree Grantor Name Identifier Scheme",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "value": "Subheading-,- Subheding",
        },
        {
            "key": "system_identifier_doi",
            "title": "Persistent Identifier(DOI)",
            "title_ja": "Persistent Identifier(DOI)",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "SYSTEMIDT Identifier Type",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "Persistent Identifier(HDL)",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "Persistent Identifier(URI)",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "SYSTEMFILE Filename Label",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "SYSTEMFILE Filename Type",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "SYSTEMFILE Filename URI",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "SYSTEMFILE DateTime Date",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
        ...
        },
        {
            ...
            "title_ja": "SYSTEMFILE DateTime Type",
            "option": {
                "required": False,
                "show_list": False,
                "specify_newline": False,
    ...
    creates = [
        {
            ...
            "creatorAffiliations": [
                {
                    "affiliationNames": [
                        {"affiliationName": "University", "affiliationNameLang": "en"}
                    ],
            ...
            "nameIdentifiers": [
                {"nameIdentifierScheme": "WEKO", "nameIdentifier": "4"},
                {
                ...
                },
                {
                    ...
                    "nameIdentifierURI": "https://nrid.nii.ac.jp/nrid/xxxxxxx",
                    "nameIdentifier": "xxxxxxx",
                },
            ],
        },
        {
            ...
            "nameIdentifiers": [
                {
                    "nameIdentifierScheme": "ORCID",
                    "nameIdentifierURI": "https://orcid.org/yyyyyy",
                    "nameIdentifier": "yyyyyy",
                },
                {
                    "nameIdentifierScheme": "CiNii",
                    "nameIdentifierURI": "https://ci.nii.ac.jp/author/yyyyyy",
                    "nameIdentifier": "yyyyyy",
                },
                {
                    "nameIdentifierScheme": "KAKEN2",
                    "nameIdentifierURI": "https://nrid.nii.ac.jp/nrid/yyyyyy",
                    "nameIdentifier": "yyyyyy",
                },
            ],
        },
        {
            ...
            "nameIdentifiers": [
                {
                    "nameIdentifierScheme": "ORCID",
                    "nameIdentifierURI": "https://orcid.org/zzzzzzz",
                    "nameIdentifier": "zzzzzzz",
                },
                {
                    "nameIdentifierScheme": "CiNii",
                    "nameIdentifierURI": "https://ci.nii.ac.jp/author/zzzzzzz",
                    "nameIdentifier": "zzzzzzz",
                },
                {
                    "nameIdentifierScheme": "KAKEN2",
    ...
    _creates = [
        {
            ...
            "creatorAlternatives": [
                {"creatorAlternative": "en_al", "al_lang": "en"},
                {"creatorAlternative": "ja_al", "al_lang": "ja"},
            ],
            "creatorAffiliations": [
                {
                    "affiliationNames": [
                        {"affiliationName": "en_af", "af_lang": "en"},
                        {"affiliationName": "ja_af", "af_lang": "ja"},
                    ]
                }
            ],
        }
...
def test_get_creator_by_languages(app):
    ...
    _create = {
        "item_1": [
            {"subitem_id": 1, "subitem_value": "ja_value_1", "subitem_lang": "ja"},
            {"subitem_id": 1, "subitem_value": "en_value_1", "subitem_lang": "en"},
            {"subitem_id": 1, "subitem_value": "no_lang_value_1"},
        ],
        "item_2": [
            {
                "subitem_id": 2,
            ...
            {"subitem_id": 2, "subitem_value": "en_value_2", "subitem_lang": "en"},
        ],
        "item_3": [
            {
                "subitem_id": 3,
            ...
            {"subitem_id": 3, "subitem_value": "en_value_2", "subitem_lang": "en"},
        ],
    }
...
def test_add_author_test(app):
    author_data = {
        "creatorName": ["Joho\t Taro", "Joho\t Taro", "Joho\t Taro"],
        "familyName": ["Joho", "Joho", "Joho"],
        "givenName": ["Taro", "Taro", "Taro"],
        "affiliationName": ["University"],
    }
    stt_key = [
        "item_1617186331708",
    ...
    is_specify_newline_array = [
        {"item_1617186331708.subitem_1551255648112": False},
        {"item_1617186385884.subitem_1551255721061": False},
        {"nameIdentifierScheme": True},
        {"nameIdentifierURI": True},
        {"nameIdentifier": True},
        {"creatorName": True},
        {"familyName": True},
        {"givenName": True},
        {"affiliationNameIdentifier": True},
        {"affiliationNameIdentifierScheme": True},
        {"affiliationNameIdentifierURI": True},
    ...
    data_result = {
        "item_1617186331708": {
            "lang": ["ja", " en"],
            "lang_id": "item_1617186331708.subitem_1551255648112",
        },
        "item_1617186385884": {
            "lang": ["en", " ja"],
            "lang_id": "item_1617186385884.subitem_1551255721061",
        },
        "nameIdentifierScheme": {
            "nameIdentifierScheme": {
                "value": [
                    "WEKO-,- ORCID-,- CiNii-,- KAKEN2-,- ORCID-,- CiNii-,- KAKEN2-,- ORCID-,- CiNii-,- KAKEN2"
                ]
            }
        },
        "nameIdentifierURI": {
            "nameIdentifierURI": {
                "value": [
                    "https://orcid.org/-,- https://ci.nii.ac.jp/-,- https://kaken.nii.ac.jp/-,- https://orcid.org/-,- https://ci.nii.ac.jp/-,- https://kaken.nii.ac.jp/-,- https://orcid.org/-,- https://ci.nii.ac.jp/-,- https://kaken.nii.ac.jp/"
                ]
            }
        },
        "nameIdentifier": {
            "nameIdentifier": {
                "value": [
                    "4-,- xxxxxxx-,- xxxxxxx-,- zzzzzzz-,- xxxxxxx-,- xxxxxxx-,- zzzzzzz-,- xxxxxxx-,- xxxxxxx-,- zzzzzzz"
                ]
            }
        },
        "creatorName": {
            "creatorName": {"value": ["Joho\t Taro", "Joho\t Taro", "Joho\t Taro"]}
        },
        "familyName": {"familyName": {"value": ["Joho", "Joho", "Joho"]}},
        "givenName": {"givenName": {"value": ["Taro", "Taro", "Taro"]}},
        "affiliationNameIdentifier": {
            "affiliationNameIdentifier": {"value": ["0000000121691048"]}
        },
        "affiliationNameIdentifierScheme": {
            "affiliationNameIdentifierScheme": {"value": ["ISNI"]}
        },
        "affiliationNameIdentifierURI": {
            "affiliationNameIdentifierURI": {
                "value": ["http://isni.org/isni/0000000121691048"]
        ...
        "affiliationName": {"affiliationName": {"value": ["University"]}},
    }
    ...
    _stt_key, _data_result, _newline_array = add_author(
        author_data,
        stt_key,
        is_specify_newline_array,
        s,
    ...
    _biblio = [
        {
            ...
            "magazine_attribute_name": [{"key": "name1"}, {"key": "name2"}],
        },
        {
            "title_attribute_name": "title2",
            "magazine_attribute_name": [{"key": "name3"}],
        },
    ]
...
def test_replace_fqdn(app):
    ...
    url = replace_fqdn(
        "http://weko3.ir.rcos.nii.ac.jp/a", "https://weko3.ir.rcos.nii.co.jp/"
    )
...
def test_replace_fqdn_of_file_metadata(app):
    ...
    _file_metadata_list2 = [
        {"url": {"url": "http://test/a"}, "version_id": "1"},
        {"url": {"url": "http://test/b"}, "version_id": "1"},
    ]

    _file_url = []
    replace_fqdn_of_file_metadata(_file_metadata_list1)
    assert _file_metadata_list1 == [
        {"url": {"url": "http://test/a"}},
        {"url": {"url": "http://test/b"}},
    ]
    ...
    assert _file_metadata_list2 == [
        {"url": {"url": "https://localhost/a"}, "version_id": "1"},
        {"url": {"url": "https://localhost/b"}, "version_id": "1"},
    ]
