...
Invenio-Admin could always use more documentation, whether as part of the
official Invenio-Admin docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
https://github.com/inveniosoftware/invenio-admin/issues.
...
3. The pull request should work for Python 2.7, 3.3, 3.4 and 3.5. Check
   https://travis-ci.org/inveniosoftware/invenio-admin/pull_requests
