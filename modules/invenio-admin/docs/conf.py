...
htmlhelp_basename = 'invenio-admin_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-admin.tex', u'invenio-admin Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-admin', u'invenio-admin Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'invenio-admin', u'Invenio-Admin Documentation',
   author, 'invenio-admin', 'Invenio module that adds administration panel to the system.',
   'Miscellaneous'),
]
