...
g = {}
with open(os.path.join('weko_items_rest', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
    version = g['__version__']

setup(
    name='weko-items-rest',
    version=version,
    description=__doc__,
    long_description=readme + '\n\n' + history,
    keywords='weko items rest',
    license='GPLv2',
    author='National Institute of Informatics',
    author_email='wekosoftware@nii.ac.jp',
    url='https://github.com/wekosoftware/weko-items-rest',
    packages=packages,
    zip_safe=False,
    ...
    entry_points={
        'invenio_base.api_apps': [
            'weko_items_rest = weko_items_rest:WekoItemsREST',
        ],
    },
