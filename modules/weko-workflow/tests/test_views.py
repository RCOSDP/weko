...
def test_check_authority_action(client, activity_acl, activity_acl_users):
    users = activity_acl_users["users"]
    activities = activity_acl
    # no authenticated
...
# .tox/c1/bin/pytest --cov=weko_workflow tests/test_views.py::test_download_activitylog_1 -vv -s --cov-branch --cov-report=term --basetemp=/code/modules/weko-workflow/.tox/c1/tmp
@pytest.mark.parametrize('users_index, status_code', [
    (0, 403),
    (1, 200),
    (2, 200),
