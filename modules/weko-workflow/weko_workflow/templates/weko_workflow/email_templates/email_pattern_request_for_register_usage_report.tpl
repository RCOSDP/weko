...
次のデータの利用期限が間近となりましたが、利用報告が登録されていません。
...
The following data is about to expire, but no usage report has been registered.
...
Please click on the link below to register a usage report as soon as possible.
