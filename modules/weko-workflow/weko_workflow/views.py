...
from .utils import IdentifierHandle, auto_fill_title, check_continue, \
    ...
    saving_doi_pidstore, \
    update_cache_data, validate_guest_activity, get_approval_keys, process_send_approval_mails, \
...
def next_action(activity_id='0', action_id=0):
    ...
    if 'approval' in [action_endpoint, next_action_endpoint]:
        ...
        next_action_detail = work_activity.get_activity_action_comment(activity_id, next_flow_action[0].action_id,
        ...
        process_send_approval_mails(activity_detail, action_mails_setting, next_action_detail.action_handler,
                                    url_and_expired_date)
