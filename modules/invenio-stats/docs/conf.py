...
latex_documents = [
  (master_doc, 'invenio-stats.tex', u'invenio-stats Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-stats', u'invenio-stats Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'invenio-stats', u'Invenio-Stats Documentation',
   author, 'invenio-stats', 'Invenio module for collecting statistics.',
   'Miscellaneous'),
]
